> 📂 **Arxiu/Ruta:** `./_PAPERERA_OBSOLETA/archivos_arqueologicos/agent/antiguos/modo-produccion/SKILL.md`
...
A) Funciona y se ve: Abre la preview sin errores. Imágenes cargan y no hay rutas rotas. Tipografías y estilos se aplican correctamente.
B) Responsive (móvil primero): Se ve bien en móvil (no se corta, sin scroll horizontal). Botones y textos tienen tamaños legibles. Secciones con espaciado coherente.
C) Copy y UX básica: Titular claro y coherente. CTAs consistentes. No hay texto "placeholder" tipo lorem ipsum.
D) Accesibilidad mínima: Contraste razonable, imágenes con alt, estructura de headings lógica.
