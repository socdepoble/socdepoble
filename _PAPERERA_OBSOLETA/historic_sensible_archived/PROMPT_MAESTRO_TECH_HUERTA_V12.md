> 📂 **Arxiu/Ruta:** `./_PAPERERA_OBSOLETA/historic_sensible_archived/PROMPT_MAESTRO_TECH_HUERTA_V12.md`
...
> Cuando rediseñes la arquitectura de un componente asegurándote de que estructuralmente es perfecto (Material/iOS), deberás envolverlo obligatoriamente y sustituir sus clases estéticas por los valores definidos en este Manifiesto Tech-Huerta. No devuelvas un diseño estándar genérico; devuelve una experiencia *Premium Rural*.
