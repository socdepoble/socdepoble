...
**Comportament i Escalabilitat:**

- **Escriptori (Expandit):** Fixa a l'esquerra (280px). Mostra Icona + Text.
- **Escriptori (Plegat / Collapsed):** Reduïda a ~80px. Mostra exclusivament les icones per a maximitzar l'espai de treball (inspiració OS/Notion).
- **Mòbil:** Oculta (Drawer). S'activa amb el botó Menú (Hamburguesa).
- **Estructura Niu (Nesting):** Ha d'estar preparada arquitectònicament per a desplegar subcarpetes (ex: organització del bloc de notes, carpetes de xat) a l'estil Raindrop o Notion. L'arbre de navegació haurà de suportar sub-nivells.
