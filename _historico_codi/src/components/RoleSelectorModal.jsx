...
const RoleSelectorModal = ({ isOpen, onClose, onSelect }) => {
    ...
    const roles = [
        ...
        { 
            ...
            avatar: '/assets/mock-data/avatars/avatar_antoni.png', 
            color: '#4CAF50', 
            route: '/chats', 
        ...
        { 
            ...
            avatar: '/assets/mock-data/avatars/avatar_carmen.png', 
            color: '#EF4444', 
            route: '/chats', 
        ...
        { 
            ...
            avatar: '/assets/mock-data/avatars/avatar_vicent.png', 
            color: '#8E8E93', 
            route: '/chats', 
        ...
        { 
            ...
            avatar: '/assets/mock-data/avatars/avatar_joanet.png', 
            color: '#5D5FEF', 
            route: '/chats', 
        ...
        { 
            ...
            avatar: '/assets/mock-data/avatars/avatar_samir.png', 
            color: '#795548', 
            route: '/chats', 
        ...
        { 
            ...
            avatar: '/assets/mock-data/avatars/avatar_maria.png', 
            color: '#E91E63', 
            route: '/chats', 
