...
const UniversalTotem = ({
    ...
    return (
        <div className={`universal-totem-container ${type} ${isEditing ? 'edit-mode-active' : ''}`}>
                            ...
                            <div className="premium-management-menu-wrapper">
                                ...
                                {isMenuOpen && (
                                    <div className="premium-dropdown-menu animate-in">
                                        ...
                                        <button className="dropdown-item" onClick={() => { navigate('/notes'); setIsMenuOpen(false); }}>
                                            <Zap size={18} />
                                            <span>LA MEUA LLIBRETA</span>
                                        </button>
