                    ...
                    {isSettingsMenuOpen && (
                        <>
                            ...
                            <div className="absolute right-2 top-14 z-50 w-64 origin-top-right animate-in fade-in zoom-in-95 rounded-[28px] bg-theme-surface/90 py-2 text-[15px] text-theme-text shadow-[0_8px_30px_rgb(0,0,0,0.2)] backdrop-blur-xl duration-200">
                                ...
                                <button onClick={() => { setIsSettingsMenuOpen(false); navigate(`/ofici/xats/${realChatId}`); }} className="w-full px-5 py-3 text-left font-['Noto_Sans'] font-medium transition-colors hover:bg-theme-accent-primary/10 hover:text-theme-accent-primary">{t('chat.group_info', 'Info. del grup')}</button>
