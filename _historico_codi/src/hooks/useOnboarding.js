...
export const useOnboarding = () => {
  ...
  const markComplete = useCallback((prefs) => {
    try {
      ...
      window.dispatchEvent(new CustomEvent('accessibilityChanged', { detail: { isAccessible: prefs.accessibility } }));
  ...
  const updatePreference = useCallback((key, value) => {
    try {
      ...
      if (key === 'accessibility') {
          window.dispatchEvent(new CustomEvent('accessibilityChanged', { detail: { isAccessible: value } }));
      }
