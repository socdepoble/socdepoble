...
import { wikipediaService } from '../core/services/wikipediaService';
import { logger } from '../utils/logger';
import UniversalTotem from '../components/UniversalTotem';
import './Towns.css';
    ...
    return (
        <div className="ayuntamiento-page animate-in">
            <UniversalTotem
                ...
                avatarUrl={shieldUrl || (town.escudo_url !== 'EMPTY' ? town.escudo_url : null)}
                coverUrl={town.cover_url !== 'EMPTY' ? town.cover_url : (town.avatar_url !== 'EMPTY' ? town.avatar_url : null)}
                ...
                <section className="institutional-wiki-section">
                    ...
                    <div className="wiki-card-institutional glass-clean p-6 border-l-4 border-orange-500 rounded-r-2xl bg-white/5">
                        ...
                        <p className="text-sm leading-relaxed opacity-90 italic">
                            {wikiData?.extract || `L'ajuntament de ${town.name} és l'òrgan de govern i administració d'aquest municipi de les nostres comarques.`}
                        </p>
                        {wikiData?.page_url && (
                            <a
