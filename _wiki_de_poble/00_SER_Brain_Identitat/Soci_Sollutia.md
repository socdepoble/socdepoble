...
categoria: 'identitat'
tipus: 'identitat-relacional'
estat: 'canonic'
pilar: '00_SER_Brain_Identitat'
description: 'Document canònic de la relació entre Sóc de Poble i Sollutia com a soci tecnològic principal.'
replaces:
  - '02_ACTUAR_Maquina_Tecnica/skills/skill_arrel.md'
  - '02_ACTUAR_Maquina_Tecnica/skills/soci_sollutia.md'
tags:
  - visio
  - cultura
  - governanca
...
Aquest document pertany a `00_SER` perquè defineix una relació d’identitat: qui és Sollutia per a Sóc de Poble, com ens hi adrecem, quin paper ocupa dins del Mas i quins límits governen la col·laboració.
...
Sollutia és soci, no amo del Mas.

IAIA MarIA és assistent i memòria viva, no substituta del Mestre.
...
- governança
- prioritat rural
- acceptació de dependències
- canvis destructius
- exposició de dades sensibles

Cap proposta tècnica, encara que siga brillant, pot saltar-se els pilars canònics.
