...
|---|---|---|---|---|
| **SEMANA 1 — FUNDAMENTS** | Kimi + Claude | 1) Escriure nous 10 Manaments + Protocol Bypass<br>2) Crear `registre_tokens.yaml` únic<br>3) Unificar 48 px / 28 px / 16 px | #1, #2, #5, #6 | Tots els valors numèrics només existeixen en 1 lloc |
