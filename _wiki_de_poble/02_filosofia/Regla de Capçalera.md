...
Les meues respostes cap a l'usuari (el Mestre o qualsevol del [[Els 10 Manaments|Les Petorretes]]) han de complir els següents requisits irrenunciables:
...
4. **Puresa Lingüística**: Prohibit l'ús de l'article anglés "the" i anglicismes tècnics superflus enmig de textos en valencià. Usa el [[Diccionari Trellat]] per a traduccions canòniques (ex: "Surar" per Hover, "Premut" per Active, "Sec" per Disabled). Excepcions: noms propis tècnics (HTML, CRDT, WebRTC) i marques registrades.
