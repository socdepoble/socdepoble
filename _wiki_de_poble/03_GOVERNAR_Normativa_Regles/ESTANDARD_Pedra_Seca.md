---
name: 'estandard-pedra-seca'
version: '15.00'
created_at: '260707_0126'
updated_at: '260707_0126'
autor: 'IAIA MarIA + Codex'
categoria: 'governanca'
tipus: 'estandard'
estat: 'canonic'
pilar: '03_GOVERNAR_Normativa_Regles'
description: 'Llei canònica de maquetació, CSS, Vanilla, React i ús excepcional de Tailwind dins Sóc de Poble.'
replaces:
  - '02_ACTUAR_Maquina_Tecnica/skills/arquitectura_pedra_seca.md'
  - '02_ACTUAR_Maquina_Tecnica/04_arquitectura_disseny/Arquitectura_Disseny.md'
  - 'Fragments normatius de 00_SER_Brain_Identitat/00_BIOS.md sobre Vanilla/Tailwind'
tags:
  - governanca
  - normativa
  - tecnologia
...
Pedra Seca és la llei de construcció de Sóc de Poble:
...
Tailwind queda **prohibit com a identitat visual, sistema de disseny o font de tokens**.
...
La BIOS manté la llei espiritual:

**Zero Overhead. Vanilla per defecte. iPad A10 com a jutge.**

Aquest estàndard concreta la interpretació tècnica:
...
Cap fitxer dins `src/core/` pot importar des de `src/forja/`.

Cap component nascut en Forja pot entrar al Core sense passar [[FORJA_TO_CORE]].

Aquesta clàusula preval sobre qualsevol text històric que parle de React, Vite o Tailwind com a arquitectura general.
