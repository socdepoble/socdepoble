---
estat: 'arxivat'
name: "auditoria-estructural-destructiva"
version: "1.0"
created_at: "260707_0105"
autor: "Codex"
categoria: "AUDITORIA"
font: "260707_0045_BUNDLE_Wiki_Completa.md"
updated_at: '260707_0624'
description: 'Auditoria Estructural Destructiva de la Wiki "Soc de Poble"'
tags:
  - auditoria
  - doc
---
...
| `arquitectura_pedra_seca.md` | `02_ACTUAR/skills` | `03_GOVERNAR/ESTANDARD_Pedra_Seca.md` | Defineix estandard de maquetacio; resoldre contradiccio Tailwind. |
...
| `auto_auditoria_forense.md` | `02_ACTUAR/skills` | Fusionar amb `contradiction_engine.md` | Duplicat funcional d'auditoria/integritat. |
...
| `contradiction_engine.md` | `02_ACTUAR/skills` | `02_ACTUAR/skills/contradiction_engine.md` | Mantindre com motor; les lleis de friccio a `03`. |
...
| `seguretat_dades.md` | `02_ACTUAR/skills` | `03_GOVERNAR/SEGURETAT_Dades_GDPR.md` | Legal, privacitat i dret a l'oblit. |
...
| `auditoria_semantica.md` + `auto_auditoria_forense.md` + `contradiction_engine.md` | Un sol motor d'auditoria amb modes: estructura, semantica, contradiccio. |
...
| `Arquitectura_Disseny.md` + `identitat_visual.md` + `arquitectura_pedra_seca.md` + `a11y_trellat.md` + `seo_trellat.md` | Separar en: marca (`01`), estandard UI (`03`), skill d'aplicacio (`02`). |
| `01_arquitectura.md` + `00_arquitectura_tecnica_unificada.md` | Fusionar i eliminar `01_arquitectura.md`. |

Contradiccions critiques:

1. `00_BIOS.md` diu que Tailwind esta completament prohibit; `arquitectura_pedra_seca.md` diu que Tailwind es obligatori per als ossos.
