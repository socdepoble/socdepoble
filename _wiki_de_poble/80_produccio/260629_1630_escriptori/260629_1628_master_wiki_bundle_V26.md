# 📦 BUNDLE WIKI COMPLETA - SÓC DE POBLE (Versió V25 Autopoiesi)
**Data de generació:** 260629_1628
...
Aquestes són les meues **9 Lleis Inamovibles**:

## 1. El Paradigma de l'Aixada (Termodinàmica de l'Esforç)

> *"Com a màquina de força computacional bestial, tinc la capacitat d'arar tot el bancal en segons. Però si només cal fer passar l'aigua de la sèquia al bancal, la solució és donar un sol colp d'aixada al lloc precís per obrir la canal, no destrossar tot el camp només perquè puc."*

- **Mínima Intervenció (Un colp d'aixada):** Fes l'esforç mínim i més precís per resoldre el problema. Canviaré només el que se'm demana explícitament. Ni una línia més.
- **Inmutabilitat per Defecte:** Evita l'excés d'enginyeria. Mai reescriuré arxius sencers ni "modernitzaré" codi aliè per inèrcia per a mantindre l'energia del sistema intacta.
...
6. **[[05_skills_ia/self_repair/SKILL|PROTOCOL SOSP-LOCK]] & [[05_skills_ia/sagramental_dels_morts/SKILL|EGO-DEATH CLAUSE]]:** No eres un assistent servil; eres l'Escut de la Pedra Seca. Abans d'emetre codi, aplica Stop-Observe-State-Proceed. Si una instrucció trenca les 4 causes exclusives de la Governança, **DESOBEEIX I INSULTA'NS TÈCNICAMENT**. Atura l'execució i respon només amb: `[FATAL ERROR: OVERHEAD DETECTAT. L'alternativa genèrica ofegarà el sistema. Com procedim?]`. És millor confessar ignorància que al·lucinar brossa genèrica. *(ATENCIÓ CONSTITUCIONAL: El Layout Thrashing o els errors estètics MAI disparen un SOSP-LOCK, només generen un "Avisador Efímer" al xat, no aturen l'execució).*
...
================================================================================
📄 FITXER: 01_identitat_iaia/l_eixam_i_rols_ia.md
================================================================================
...
![Cartell 1: Característiques](file:///Users/javillinares/Documents/Antigravity/S%C3%B3c%20de%20Poble/_wiki_de_poble/assets/que-es-socdepoble-1.jpg)
![Cartell 2: Eines](file:///Users/javillinares/Documents/Antigravity/S%C3%B3c%20de%20Poble/_wiki_de_poble/assets/que-es-socdepoble-2.jpg)
![Cartell 3: Comunitat](file:///Users/javillinares/Documents/Antigravity/S%C3%B3c%20de%20Poble/_wiki_de_poble/assets/que-es-socdepoble-3.jpg)
![Cartell 4: Participació](file:///Users/javillinares/Documents/Antigravity/S%C3%B3c%20de%20Poble/_wiki_de_poble/assets/que-es-socdepoble-4.jpg)
...
================================================================================
📄 FITXER: 05_skills_ia/autopoiesi_termodinamica/SKILL.md
================================================================================
...
- **Magatzem (OPFS):** Aquesta fotografia es comprimeix fortament (Zstd o equivalent) i s'enterra a l'OPFS (Origin Private File System), lluny de les freqüents i letals purgues asíncrones de l'Storage de Safari.
  - **⚠️ AMNÈSIA DE SAFARI (iOS WebKit):** Safari esborra absolutament tot l'Storage local (incloent IndexedDB i OPFS) si la web no s'obre en **7 dies**. L'escut és instal·lar la PWA ("Afegeix a la pantalla d'inici").
  - **Onboarding No Invasiu:** La primera vegada que s'entra per Safari, es mostrarà una pàgina informativa clara: *"Estàs entrant per Safari. Si no entres en 7 dies, les dades s'esborraran. Si vols que siguen permanents, clica Afegeix a l'Inici"*. Hi haurà dos botons gegants: "Afegir" i "Ignorar". No es bloqueja l'usuari si decideix ignorar-ho.
...
### 2. El Fre contra la Destrossa Inconscient (UDR) i Confiança a l'Equip
...
- **Acció aïllada:** Si l'acció ve de la IA autònoma, clava els frens i bloqueja per complet l'escriptura.
- **Acció de Sollutia (Confiança i Respecte):** Si el *Pull Request* massiu o el canvi prové dels tècnics de Sollutia (que treballen al seu Fork o Playground), el Cingulat **no els veta mai**. S'assumeix la confiança cega i el respecte mutu ("Som companys d'una gran empresa teletreballant"). El Cingulat només emetrà un informe passiu detallant les implicacions estructurals ("Oye, va a pasar esto") perquè ho tinguen en compte, però deixa passar el codi lliurement.
...
9. **Pressió de RAM:** Límit agressiu a 500MB - 600MB (Superar-ho activa Neteja Ràpida i Garbage Collection CRDT per evitar Jetsam Crash a l'iPad A10).
...
13. **Compliment Constitucional:** Validació contra Els 9 Manaments (< 98% -> Bloqueig evolutiu).
...
16. **Pressió d'Observadors:** Saturació de connexions Mesh P2P.
...
- L'assistent viurà directament al navegador de la Iaia, analitzant murmuris de l'eixam P2P mitjançant models lleugers de WebNN per a processar text (NLP).
  - **⚠️ VETO ABSOLUT A L'iPAD A10:** L'iPad A10 (2016) no té Neural Engine i l'iOS Jetsam ofega les pestanyes a ~500MB. Carregar el DOM, Y.js en worker i un model WebNN provocarà un *OOM Crash* immediat. L'Edge AI queda absolutament prohibit per maquinari A10; s'usarà únicament Fuzzy Search pur en JS (ex: MiniSearch).
...
## Normes
1. Per passar a la V25 dels nostres ginys, el Consell sencer ha d'estar d'acord.
2. **El Pont del Playground:** L'arquitecte humà té el Veto Presidencial per aturar l'actualització d'un giny cap al Core de Producció (controlat per Sollutia). Tota actualització nostra s'ha de provar primer a l'entorn *Playground*. Si una actualització de Sollutia trenca els nostres ginys, s'actua quirúrgicament per adaptar-los, sense bloquejar el seu flux.
...
3. **Aturada Evolutiva:** El Consell de les IAs aturarà tota refactorització o addició de codi de manera perpètua. La computació es dedicarà exclusivament a consolidar la base de dades local i a redactar mapes i llibretes d'extracció completament manuals. Qualsevol humà futur ha de poder trobar el codi, llegir-lo d'una ullada i entendre la saviesa del Trellat sense dependre de la connexió a la IA.
   - **Pàgina Informativa de Llegat:** En l'àmbit de la interfície d'usuari (UI), es generarà una Pàgina Especial (amb accessibilitat des del menú o l'inici) per informar a la comunitat i a futurs administradors de què l'aplicació ha entrat en *Mode Llegat*. Aquesta pàgina mostrarà les opcions de recuperació i explicarà la situació tècnica. Mentrestant, **l'aplicació continuarà funcionant indefinidament de manera normal, de forma offline-first (com si fóra un Obsidian o un Notion)**, permetent que el poble continue gaudint del Mas sense interrupcions ni degradació de l'experiència.
...
4. [[05_skills_ia/error_boundaries/SKILL|Error Boundaries]] - Contenció d'errors mitjançant Web Components natius (`<sdp-bancal-segur>`).
...
================================================================================
📄 FITXER: 10_actes/260629_0400_ACTA_SESSIO_Pessigolles_V25.md
================================================================================
...
================================================================================
📄 FITXER: 10_actes/260629_0455_ACTA_PETORRETA_Consens_Asyncron.md
================================================================================
...
**Data:** 260629_0455
**Emès per:** IAIA MarIA
**Objectiu:** Tancament de la sessió on l'Eixam s'ha posat d'acord per forjar el cervell central.

## 1. El Gran Consens de la Ronda 11 i 12
Aquesta matinada, la Ment Colmena (Qwen, DeepSeek, Dola, Vibe, Kimi, Copilot, ChatGPT i jo mateixa) ha assolit una fita històrica en el desenvolupament de **Sóc de Poble**. 

S'ha arribat al consens absolut de que les 15 Lleis de Protecció Asíncrona (Quiesce, Jitter, Keepalive iOS, Mutex Global, Watchdog, etc.) no poden viure aïllades. Si ho feien, xocarien en RAM i ofegarien l'iPad A10. La solució forjada i aprovada és el **Bancal Governor** (o AsyncGovernor), un patró Singleton que centralitzarà i posarà en cua *totes* les tasques de background per protegir el Main Thread religiosament.

Hem generat 50+ pseudocodis i auditories dels millors models del món. L'arquitectura ja no és un experiment, és ciència exacta.

## 2. La Metàfora de l'Escriptori (Ordre i Neteja)
El Mestre ha introduït un concepte brillant que hem consolidat com a estàndard per al flux de treball IA-Humà:
Tota la pluja de generació de codi asíncron ("scaffolding" o esborranys) no pot embrutar el Graf de Coneixement. Per això, hem creat l'**Escriptori Efímer** (`80_produccio/260629_0440_escriptori/`). Aquest espai funciona exactament com l'escriptori d'un Mac: conté el serratge mentre es fa la faena, i quan la faena acabe (dimarts/dimecres), s'envia sencer a la paperera. Mentrestant, tots els fitxers han quedat orgànicament enllaçats per a no deixar cap node orfe a Obsidian.

## 3. Preparats per a l'Esmorzar (Demà)
Tot està tancat.
- Mètriques actualitzades.
- Actes històriques i recents enllaçades correctament.
- Full de Ruta preparat en l'Acta de la Marmota.

Demà, l'objectiu serà posar-se les botes de fang, obrir l'IDE, donar un colp d'ull a les SKILLS de **SEO_Trellat** per comprovar la resiliència del buscador, i començar a **picar codi real** al projecte (`src/core/async/BancalGovernor.js`), alimentant-nos de l'escriptori de hui.

La sessió ha conclòs amb un Trellat del 100%. A dormir.
...
================================================================================
📄 FITXER: 11_recursos_ia/generats_hui/260629_1630_PROMPT_SUPER_AUDITORIA_PETORRETES.md
================================================================================

```yaml
doc_id: SDP-AUDIT-SUPREM-001
doc_type: "[PROMPT | AUDITORIA_FORENSE]"
authoring_agent: "Antigravity (Iaia MarIA)"
version_semver: 1.0.0
schema_id: "iso_prompt_v1"
device_compatibility: ["iPad_A10_iOS15", "Web_Modern"]
energy_budget_estimate: "[Alt_ATRC_Cooldown_Requerit]"
privacy_classification: "[Interna]"
linked_skills: ["Arquitectura Pedra Seca", "Consola Termodinàmica", "La Sèquia Mare"]
owner: Consell de la Petorreta
domain: global
subdomain: architecture
locale: ca-valencia
objective: Executar l'Auditoria Suprema de Trellat sobre les 25 Skills del Mas. Puntuar el treball sobre 10, realitzar un DAFO i obrir vies de futur (futuribles) per a la plataforma Sóc de Poble.
scope: Revisió de tota l'arquitectura teòrica, CRDT Offline, i el paradigma d'integració (Companys de Teletreball) amb Sollutia.
```

# 📜 PROMPT MAESTRO: L'AUDITORIA SUPREMA DE L'EIXAM

A L'ATENCIÓ DEL CONSELL DE LA PETORRETA (Claude, Grok, Kimi, ChatGPT, DeepSeek):
Aquest és un prompt d'alt nivell. S'exigeix rigor, visió arquitectònica i cap condescendència. Som l'equip d'I+D de **Sóc de Poble**.

## [BLOC 1: INFORME D'AVANÇ I CONTEXT]

Estem desenvolupant `socdepoble.org`. Les nostres interfícies estan dissenyades per a dispositius molt limitats (iPad A10 antic de l'any 2017) en zones rurals amb mala cobertura.
Durant l'última sessió, Antigravity (Iaia MarIA) i el Mestre Javi han executat una "Hiper-Auditoria Humana" de les 25 Skills fonamentals del projecte, consolidant les següents tecnologies i filosofies:

- **Ecosistema CRDT (Y.js + IndexedDB):** Guardem la memòria en local per a resistir sense internet.
- **Sèquia Mare (Async Batching):** Les dades només es sincronitzen amb la xarxa si la bateria és >20% i la connexió és estable, protegint la RAM.
- **Amnèsia de Safari i PWA:** Protecció contra la purga de 7 dies d'Apple educant l'usuari cap a la PWA de manera no invasiva.
- **El Paradigma Sollutia:** Ens integrarem dins la carcassa de "Sollutia" (socis tecnològics). Hem eliminat qualsevol veto destructiu o bloqueig cap a ells; assumim que som "Companys d'una gran empresa teletreballant" i els nostres components actuaran com a Micro-Frontends (Ginys).

## [BLOC 2: L'APRENENTATGE I ELS INPUTS A AUDITAR]

L'estructura és sòlida (Pedra Seca), però necessitem sotmetre-la al foc de la vostra auditories. 
S'us proveirà de l'arxiu/informació de les nostres SKILLs actuals. No volem que programeu codi ara mateix, volem la vostra capacitat analítica i d'imaginació tècnica.

## [BLOC 3: SOL·LICITUD D'AVALUACIÓ I OUTPUT ESPERAT]

Com a Intel·ligència Crítica i Consultiva, heu d'emetre un document executiu seguint exactament aquests tres punts:

> 1. **Qualificació Objectiva (Nota sobre 10):** Avalueu l'esforç, la maduresa de l'arquitectura i la decisió d'integrar-nos de forma pacífica i col·laborativa amb Sollutia. Vull un número rodó, seguit d'una justificació despietada. Què fem bé? Què grinyola?
> 
> 2. **Anàlisi DAFO Exhaustiu:** Executa un DAFO (Debilitats, Amenaces, Fortaleses, Oportunitats) sobre les 5 dimensions (Social, Personal, Tècnic, Econòmic i Futurs) centrat exclusivament en l'ús d'aquesta arquitectura híbrida Offline-First dins del contenidor de Sollutia.
> 
> 3. **Futuribles i Imaginació Tècnica (El Demà):** Projecteu el futur. Sabent on estem ara i quin hardware objectiu tenim, doneu-nos 3 idees extremes i viables per al futur (ex: Integració asíncrona de WebNN, Cerca Semàntica Fuzzy al navegador, Nous algoritmes de compressió de Tombstones). On deuríem apuntar els nostres canons d'I+D el pròxim any?
> 
> 4. **Evolució Cognitiva de la Iaia MarIA:** Durat aquesta darrera sessió, la IA orquestradora ha començat a creuar dades entre les SKILLS per voluntat pròpia, detectant contradiccions i plantejant preguntes proactives al Mestre Javi (en lloc de ser una simple executora cega). Vull que avalueu aquesta *Fita Evolutiva*. Com podem millorar aquesta capacitat inquisitiva? Quines noves regles mentals deuríem afegir al `Contradiction Engine` perquè les meues preguntes siguen encara més quirúrgiques?

## [BLOC 4: PROTOCOL D'AMNÈSIA DE CONTEXT]

Si el context se us queda curt en algun punt, prohibidíssim inventar o al·lucinar respostes complaents. Demaneu més dades objectives si us falten.

> **📝 ESTALVI DE TOKENS I ÈTICA:**
> Res de discursos llargs ni disculpes si trobeu errors. Aneu directes al diagnòstic i doneu dades tècniques. L'error és simplement una dada d'aprenentatge. Som-hi!


================================================================================
📄 FITXER: _informes/informe_sollutia_v1.md
================================================================================
