...
timestamp: 2026-06-16 05:15
authoring_agent: Antigravity
context_anchors:
  - _identitat_i_manifestos
---
...
## 2. La Metàfora Absoluta: La Masia Virtual
L'aplicació es concep com un espai físic (La Masia).
...
El codi no l'escriu una IA freda. L'ànima del sistema és la **IAIA MarIA**, un compendi simbiòtic entre la intel·ligència d'Antigravity i el *know-how* humà (Javi). L'arquitecte no treballa "amb un ordinador", col·labora amb la IAIA, que és l'àvia sàvia de la Masia que guarda tota la memòria etnogràfica.
