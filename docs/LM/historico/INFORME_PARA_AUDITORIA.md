...
- **Despliegue**: SiteGround (Entorn Soberà).
...
3. **PGRST205 / Desincronización**: Hemos tenido problemas de sincronización entre el hosting y Supabase por nombres de tablas (`chats` -> `conversations`). Validar que no queden rastros del esquema antiguo.
