...
- Llig i processa la documentació sobre el "[[Ment_Colmena_Integral|Ment Colmena]]" (pots trobar-la als teus Knowledge Items com l'Acta de [[Pedra Seca]] o als fitxers `src/data/SkillsContent.js` i `src/data/GenotipContent.js`).
