...
const newPosts = `  // --- NOU LORE D'AGENTS 2026 ---
  {
...
content = content.replace('export const MOCK_FEED = [', 'export const MOCK_FEED = [\n' + newPosts);

// Safe replacements using explicit matching
...
console.log('MOCK_FEED updated with ES Modules script!');
