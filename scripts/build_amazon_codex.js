...
const chapterSources = [
    ...
    { path: path.join(ROOT_DIR, '.agents/workflows/00_CORE_SKILLS_CONSOLIDATED.md'), title: 'Protocol Base: Les Habilitats Core' },
    { path: path.join(ROOT_DIR, '.agents/workflows/01_TECH_HUERTA_ROADMAP.md'), title: 'Ruta Tech-Huerta V12' },
    { path: path.join(ROOT_DIR, '.agents/workflows/02_DESIGN_SKILLS_UNIFIED.md'), title: 'Disseny Unificat' }
];
