    ...
    lineHeight: 1.4
      ...
      alignItems: 'center'
        ...
        <div>
          ...
          fontSize: 12,
          color: '#666'
        }}>Xarxa social rural i sobirana</div>
        </div>
        ...
        alignItems: 'center'
          ...
          <button onClick={checkForUpdates} disabled={!swSupported || checking} style={{
          padding: '8px 12px',
          background: '#0b74de',
          color: '#fff',
          border: 'none',
      ...
      outline: 'none'
        ...
        marginTop: 20
          ...
          <h3 style={{
          marginBottom: 8
        }}>Logs recents del Service Worker</h3>
          <pre style={{
          background: '#f7f7f7',
          padding: 12,
          borderRadius: 6,
      ...
      textAlign: 'center'
        ...
        Consell de la Petorreta · Arquitectura local-first
      </footer>
    </div>;
}