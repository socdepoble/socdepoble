...
const AccessibilitatUniversal = () => {
  ...
  return (
    <>
      ...
      <div
        className="accessibilitat-overlay fixed inset-0 bg-black/80 backdrop-blur-sm z-[9999]"
      ...
      <div
        className="accessibilitat-modal fixed right-0 top-0 h-full w-full max-w-md bg-theme-surface border-l border-theme-border z-[10000] shadow-2xl animate-in slide-in-from-right"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <header className="accessibilitat-header h-[56px] min-h-[56px] px-4 flex items-center justify-between border-b border-theme-border flex-shrink-0">
          <h2 
        ...
        >
          ...
          {/* [ARIA] Panells de contingut */}
          <main className="accessibilitat-panels p-4 space-y-4">
            {/* PANEL GLOBAL */}
            <section
              role="tabpanel"
              id="panel-global"
