        ...
        <div className="flex-1 flex flex-col min-w-0 bg-[#000000] relative overflow-hidden h-full chat-list-container">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar bg-black min-h-0">
                {filteredChats.length > 0 ? filteredChats.map(chat => (
                    ...
                    >
                        {chat.tag && (
                            <span className="absolute top-2 left-4 bg-black text-[#FF6B00] text-[12px] px-5 py-1.5 rounded border border-[#FF6B00]/40 font-black tracking-tighter uppercase shadow-2xl leading-none z-10 translate-x-[-4px]">
                                {chat.tag}
                            </span>
                        )}
