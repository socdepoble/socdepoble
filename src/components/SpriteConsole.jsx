...
export default function SpriteConsole() {
  ...
  const { trigger, stopAll } = useSpriteAnimator(wrapperRef, sequences[selectedSprite], { autoReset: true });
  ...
  return (
    <div className="p-4 bg-[var(--sdp-bg-surface)] rounded-md shadow-sm">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-2 flex gap-4">
          <div ref={wrapperRef} className={`p-4 rounded bg-slate-800 flex items-center justify-center ${isVisible ? 'is-visible' : ''}`} style={{ minWidth: 320 }}>
