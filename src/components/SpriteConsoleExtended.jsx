...
export default function SpriteConsoleExtended() {
  ...
  const { trigger, runMacro, stopAll } = useSpriteAnimator(wrapperRef, sequences[selectedSprite], { autoReset: true });
  ...
  function handleRunMacro(name) {
    ...
    const blocks = macro.map(item => {
      ...
      return { root, steps: seq || [], offset: item.offset || 0, meta: item };
  ...
  const SpritePreview = ({ keyName }) => {
    ...
    return (
      <div id={id} className="p-2 bg-[var(--sdp-bg-primary)] rounded" style={{ width: size + 40 }}>
  ...
  return (
    <div className="p-4 bg-[var(--sdp-bg-surface)] rounded-md shadow-sm space-y-4">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-2 space-y-3">
          ...
          <div className="bg-[var(--sdp-bg-primary)] p-3 rounded">
          ...
          <div className="bg-[var(--sdp-bg-primary)] p-3 rounded space-y-2">
