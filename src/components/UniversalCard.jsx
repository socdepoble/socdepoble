...
const UniversalCard = ({ item, variant, onLike, onComment, onContact }) => {
  return (
    <div className="bg-white border border-slate-200 p-4 rounded-2xl shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
      ...
      {variant === 'market' && (
        <div className="mb-4 text-orange-600 font-bold text-xl">
      ...
      <div className="flex gap-2 text-sm border-t pt-3 mt-2 border-slate-100">
        ...
        {variant === 'market' && (
          <button onClick={onContact} className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 rounded-lg text-white font-bold w-full">
            Contactar
          </button>
        )}
      </div>
