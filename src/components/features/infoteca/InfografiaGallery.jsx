...
const INFOGRAFES_DATA = [
        {
            ...
            data: '15/02/2026',
            img: '/assets/mock-data/illustrations/infografia_kit_digital.png',
        ...
        },
        {
            ...
            sector: 'Territori',
            data: '15/02/2026',
            img: '/assets/mock-data/illustrations/territori.png',
...
const InfografiaGallery = () => {
    ...
    return (
        <div className="infoteca-container animate-in">
            <div role="region" aria-label="Capçalera de Secció" className="infoteca-header">
