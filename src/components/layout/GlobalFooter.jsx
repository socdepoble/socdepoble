...
const GlobalFooter = ({ className = "" }) => {
  ...
  return (
    <div className={`w-full relative z-20 flex px-4 pb-[max(env(safe-area-inset-bottom),0.5rem)] pt-2 items-center justify-center ${className}`}>
