                ...
                <div className="m3-dialog-body scrollable">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex gap-4">
                            <div className="flex-1">
                                <input
                                    type="text"
                                    className="w-full bg-white/5 border border-white/10 rounded-[28px] p-4 text-white placeholder-white/40 focus:outline-none focus:border-white/30"
                                    placeholder="Preu antic (Opcional)"
                        ...
                        <div className="flex gap-4">
                            <div className="flex-1">
                                <select 
                                    className="w-full bg-white/5 border border-white/10 rounded-[28px] p-4 text-white focus:outline-none focus:border-white/30"
