...
const AgentSelectorModal = ({
      ...
      state: {
        ...
        chatInfo: {
          ...
          other_info: {
            id: targetId,
            name: agent.name,
            avatar_url: agent.avatar_url || (agent.id === 'iaia-directa' ? '/uploads/avatars/iaia_comic_matriarch.png' : ''),
            role: agent.role,
            scope: agent.scope
          }
        }
  ...
  return <div className="modal-overlay animate-in" onClick={onClose}>
            <div className="agent-selector-content glass-morphism" onClick={e => e.stopPropagation()}>
                <div role="region" aria-label="Capçalera de Secció" className="agent-header">
                ...
                <div className="agents-grid">
                    {agents.map(agent => <div key={agent.id} className="agent-card" style={{
