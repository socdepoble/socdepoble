...
const GlobalModals = () => {
    const { isCreateModalOpen, isPostModalOpen, isEventModalOpen, isMarketModalOpen, isSocialManagerOpen, postModalConfig, isConnectionModalOpen, connectionConfig, isAgentSelectorOpen, agentSelectorConfig, isViewerOpen, viewerConfig, isLegalModalOpen, legalConfig, editConfig, isEditModalOpen, isMagicPregonerOpen, isTranslationModalOpen, translationConfig } = useModalState();
    const { setIsPostModalOpen, setIsEventModalOpen, setIsMarketModalOpen, setIsSocialManagerOpen, closeConnectionModal, closeAgentSelector, closeViewer, closeLegalModal, closeEditModal, setIsMagicPregonerOpen, closeTranslationModal } = useModalDispatch();
    ...
    const closeAnyModal = () => {
        ...
        else if (isTranslationModalOpen) closeTranslationModal();
        ...
        <Portal>
            ...
            {isViewerOpen && viewerConfig && (
                <MediaViewerModal
                    ...
                    imageDescriptions={viewerConfig.imageDescriptions}
                />
            )}
