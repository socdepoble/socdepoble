...
const TranslationModal = ({
  ...
  return (
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 notranslate" style={{
        zIndex: 10000
      }} onClick={onClose}>
                <div className="relative w-full max-w-sm mx-4 shadow-2xl bg-white dark:bg-[#141417] rounded-3xl border border-black/10 dark:border-white/10" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="p-6 pb-4">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className='text-xl font-black text-sdp-theme-accent-primary tracking-tight leading-tight'>
                                Traduir Contingut
                            </h2>
                        </div>
                        ...
                        <div className="flex flex-col gap-2 mb-2">
                            ...
                            <button onClick={handleRestore} className="flex items-center justify-center w-full p-3.5 mb-2 rounded-xl bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all text-center group">
