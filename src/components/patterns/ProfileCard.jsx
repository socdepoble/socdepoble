...
const ProfileCard = ({
  ...
  return <UniversalCard item={agentItem} avatarName={name} title={name} excerpt={agentItem.excerpt} image={avatarUrl} viewMode="grid" variant="agent" onNavigate={() => onNavigate(id)} />;
};
