...
export default function UniversalAjuntament({
  entity,
  isOwner,
  onSettingsClick
}) {
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
              <div className="flex flex-row items-center gap-4">
                  <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border-4 border-theme-panel bg-theme-panel overflow-hidden shadow-sm glass-rural shrink-0">
                    {profile.avatarUrl ? <div className={`w-full h-full flex items-center justify-center ${profile.role === 'ajuntament' ? 'bg-white p-1.5 sm:p-2' : ''}`}>
                        <img src={profile.avatarUrl} alt={profile.displayName || "Avatar"} className={profile.role === 'ajuntament' ? 'max-h-full max-w-full object-contain' : 'w-full h-full object-cover'} />
