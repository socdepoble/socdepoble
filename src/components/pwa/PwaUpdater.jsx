...
export function PwaUpdater() {
  ...
  if (circuitBroken) {
    return (
      <div style={{ position: 'fixed', bottom: 20, right: 20, background: '#ef4444', color: 'white', padding: '16px', borderRadius: '8px', zIndex: 9999, boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
  ...
  if (needRefresh) {
    return (
      <div style={{ position: 'fixed', bottom: 20, right: 20, background: '#f97316', color: 'white', padding: '16px', borderRadius: '8px', zIndex: 9999, boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
