...
export const SyncIndicator = () => {
  ...
  return (
    <div className="fixed bottom-[85px] right-4 flex items-center gap-2 bg-gray-900 border border-gray-700/50 text-white px-3 py-2 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.4)] text-[12px] font-bold z-[100] transition-all duration-300 pointer-events-none">
