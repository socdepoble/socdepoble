    ...
    const handleSWUpdate = event => {
      ...
      toast.custom(t => <div className="sw-update-toast">
          ...
          gap: '8px'
            ...
            toast.dismiss(t.id);
          }} className="sw-update-btn refresh" style={{
            width: '100%',
            marginBottom: '4px'
          }}>
                            ENTRAR ARA
          ...
          }} className="sw-update-btn later" style={{
            width: '100%',
