...
// Actualitzat V10.38.45
export const APP_VERSION = "V10.38.46";
...
export const USER_ROLES = {
  ...
  // Javi & Damià (Poders Totals)
  ADMIN: "admin",
  // Administrador general de continguts i entitats
  REGION_COORDINATOR: "region_coordinator",
  // Gestor d'una Comarca sorda
  TOWN_COORDINATOR: "town_coordinator",
  // Gestor d'un Poble sencer
  GROUP_COORDINATOR: "group_coordinator",
  // Moderador/Coordinador de Grups o Fòrums
  NEIGHBOR: "vei",
  // Usuari Estàndard
 ...
 */
export const CREATOR_EMAILS = ["socdepoblecom@gmail.com", "damimus@gmail.com", "javillinares@gmail.com" // Javi Llinares - Coordinador [Master]
];
