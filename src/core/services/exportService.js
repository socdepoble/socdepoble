            ...
            <body>
                <div class="sheet">
                    ...
                    <div style="flex: 1; display: flex; flex-direction: column; justify-content: center;">
                        <img src="/assets/mock-data/illustrations/infografia_kit_digital.png" class="infography-cover">
                        <h1>${userName}</h1>
                ...
                <div class="sheet">
                    <div class="page-header">
                        <img src="/system/ui/logo-socdepoble-rect-negre.svg" style="height: 15pt;">
                ...
                `).join('')}
                    ...
                    <div class="footer" style="flex-direction: column; gap: 2mm; height: auto; padding: 5mm 0;">
                        <div style="display: flex; align-items: center; justify-content: center; gap: 4mm;">
                            <img src="/system/ui/logo-socdepoble-rect-negre.svg" style="height: 12pt;">
        ...
        let html = `
            ...
            <body>
                <div class="page-container">
                    <div class="header">
                        <img src="/system/ui/logo-socdepoble-rect-negre.svg" style="height: 24pt;" alt="Sóc de Poble">
