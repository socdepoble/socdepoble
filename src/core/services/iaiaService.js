...
import { getPersonaKeyByUUID } from '../../app/config/agentsMap';
...
class IAIAService {
    constructor() {
        ...
        this.AVATARS = {
            OFFICIAL: "/uploads/avatars/iaia_comic_matriarch.png",
            ARXIU: "/uploads/avatars/iaia_memory.png",
            MERCAT: "/uploads/avatars/iaia_secretary.png",
            HORTA: "/uploads/avatars/iaia_comic_matriarch.png",
            BENVINGUDA: "/uploads/avatars/iaia_comic_matriarch.png"
        };
    }
        ...
        try {
            ...
            if (seed < 0.7) {
                ...
                const postPayload = {
                    ...
                    author_avatar_url: '/uploads/avatars/iaia_memory.png',
                    author_role: 'official',
        ...
        try {
            ...
            if (conversationId && conversationId !== 'preview') {
                ...
                const fillerObj = {
                    ...
                    author_avatar_url: persona?.avatar_url || '/uploads/avatars/iaia_comic_matriarch.png',
