...
export const profileHealingService = {
  ...
  protectMasterIdentity(session, profileData) {
    ...
    const effectiveProfile = {
      ...
      avatar_url: isOfficialCreator ? '/uploads/avatars/javi-llinares-foto_perfil-01.jpg' : (supabaseService.normalizeStorageUrl(profileData?.avatar_url) || null),
      header_image_url: isOfficialCreator ? '/uploads/avatars/javi_cover.jpg' : profileData?.header_image_url,
