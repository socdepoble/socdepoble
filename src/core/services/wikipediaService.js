...
export const wikipediaService = {
        ...
        try {
            ...
            return items
                ...
                .filter(img => {
                    ...
                    const isMap = lurl.includes('.svg') || lurl.includes('escut') || lurl.includes('escudo') || 
    ...
    async getTownShield(townName) {
        try {
            ...
            const lowerTown = townName.charAt(0).toLowerCase() + townName.slice(1);
            const queries = [
                `File:Escut de ${townName}.svg`,
                `File:Escut de ${lowerTown}.svg`,
                `File:Escudo de ${townName}.svg`,
                `File:Escudo de ${lowerTown}.svg`,
                `File:Escut de ${townName}.png`,
                `File:Escut de ${lowerTown}.png`,
