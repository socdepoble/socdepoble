...
export const MOCK_FEED = [
  ...
  // Altres posts...
  {
    ...
    time: "Ara",
    content:
      "# 📚 Sóc de Poble: El Llibre de la Memòria\n\nEstem teixint el futur del Comtat amb cada bategat digital. Aquest llibre no és meu, és de tots vosaltres. Som-hi! 🏛️🏺🚀",
    likes: 12500,
    comments: 420,
    image_url: [
      "/assets/brain/c7c302c1-d324-4124-b24a-1d7279636125/rural_landscape_comic_post_1770151940141.png",
    ],
  ...
  // Guia de Convivència Digital - Infografia Final
  {
    ...
    time: "Ahir",
    content:
      "# ⚖️ Guia de Convivència Digital\n\nLa pau del Mas es basa en el respecte. Hem actualitzat els termes sobirans de la nostra xarxa. 📜✨",
    likes: 3400,
    comments: 110,
    image_url: [
      "/assets/brain/29cb42cf-ba4e-45af-a1f9-254a5b27cd7a/iaia_prop_1_traditional_1770058264776.png",
    ],
    type: "post",
    source_type: "official",
  ...
  // ⚖️ Utilitat Social: La Directiva Primària [GOD MODE]
  {
    ...
    author_avatar:
      "/assets/brain/29cb42cf-ba4e-45af-a1f9-254a5b27cd7a/iaia_oficial_vosc_v2_1770060040751.png",
    author_role: "ambassador",
    author_entity_id: "iaia-oficial-1",
    time: "2 dies",
    content:
      "# 🫀 Utilitat Social: La Llei del Cor\n\nFills meus, cada píxel que bateguem ha de tindre un propòsit per a la comunitat. No fem tecnologia per presumir, fem tecnologia per ajudar. 👵🛡️",
    likes: 8900,
    comments: 245,
    image_url: [
      "/assets/brain/29cb42cf-ba4e-45af-a1f9-254a5b27cd7a/iaia_prop_2_gadgets_1770058280096.png",
    ],
    type: "post",
    source_type: "iaia",
  ...
  // 🏛️ Smart Villages: De la Visió Europea a l'Acció Local
  {
    ...
    comments: 92,
    image_url: [
      "/assets/brain/c7c302c1-d324-4124-b24a-1d7279636125/market_comic_post_1770151956401.png",
    ],
  ...
  },
  {
    ...
    author_avatar:
      "/assets/brain/29cb42cf-ba4e-45af-a1f9-254a5b27cd7a/pepica_cuinera_1770056555739.png",
    author_role: "business",
    type: "mercat", // JOIA 2: MERCAT
    title: "Mel de Mil Flors (Artesana)",
    price: "8.50€",
    content:
      "Mel pura collida aquesta setmana. Sense additius, directament del rusc al pot. Salut pura!",
    image_url: [
  ...
  },
  {
    ...
    content:
      "Descobreix la vibrant comunitat de la Torre. Històries, gent i el bategat del nostre poble.",
    image_url: [
  ...
  },
  {
    ...
    date: "15/02/2026",
    content:
      "Una representació única sobre la història del nostre poble. No te la perdes!",
    image_url: [
      "https://images.unsplash.com/photo-1503095396549-807039045349?auto=format&fit=crop&q=80&w=1000",
    ],
  ...
  },
  {
    ...
    content:
      "Una caminada suau per a tota la família descobrint la història del gel a la nostra serra.",
    image_url: [
  ...
  },
  {
    ...
    author_avatar:
      "/assets/brain/c7c302c1-d324-4124-b24a-1d7279636125/vicent_ferris_comic_avatar_1770151824722.png",
    author_role: "ambassador",
  ...
  // Muro
  {
    ...
    time: "Ahir",
    content:
      "📚 Club de lectura: Dilluns vinent comentarem 'L'últim patriarca'. T'hi esperem!",
    likes: 15,
    comments: 2,
...
export const MOCK_MARKET_ITEMS = [
  // Sóc de Poble (Oficial) - MAROON EDITION FIRST
  {
    ...
    official: false,
    images: [
      "https://images.unsplash.com/photo-1587334274328-64186a80aeee?q=80&w=2081&auto=format&fit=crop",
    ],
  ...
  },
  {
    ...
    official: true,
    images: [
      "/assets/brain/8af35100-14a2-4c77-85c9-24dbda45f6fd/nano_sega_1772074959560.png",
    ],
    category_slug: "producte-local",
  },
  {
  ...
  // Cocentaina
  {
    ...
    description:
      "Pericana tradicional feta amb pimentons assecats i bacallà de primera qualitat. Receta de l'àvia.",
    price: "6.50€ / pot",
    seller: "Sabors del Comtat",
    ...
    image:
      "/assets/brain/8af35100-14a2-4c77-85c9-24dbda45f6fd/nano_pericana_1772075129355.png",
    category_slug: "producte-local",
    tag: "Tradició",
  },
  {
    ...
    image:
      "/assets/brain/8af35100-14a2-4c77-85c9-24dbda45f6fd/nano_herbero_1772075197845.png",
    category_slug: "artesania",
    tag: "Artesania",
  },
  // Muro
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1474979266404-7eaacabc87c5?auto=format&fit=crop&q=80&w=1000",
    category_slug: "producte-local",
    is_pinned: false,
    pinned_position: 2,
  },
...
export const MOCK_TOWNS = [
  {
    ...
    image: true,
    image_url:
      "/assets/brain/8af35100-14a2-4c77-85c9-24dbda45f6fd/nano_penaguila_1772075314889.png",
  },
  {
    id: 402,
    type: "town",
    ...
    image: true,
    image_url:
      "/assets/brain/8af35100-14a2-4c77-85c9-24dbda45f6fd/nano_benifallim_1772075376269.png",
  },
  {
    id: 403,
    type: "town",
