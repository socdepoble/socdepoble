...
export const MOCK_CHATS = [
  ...
  },
  {
    ...
    type: "iaia",
    unread: 0,
    avatar_url: "/assets/brand/carmen_forn_comic.png",
    is_iaia: true,
  },
  {
    id: "el-gall",
...
export const MOCK_FEED = [
  ...
  { id: "projecte-llibre",
    ...
    likes: 1982,
    comments: 45,
    image_url: ["/assets/avatars/hero_nano_final.png"],
    type: "page",
    slug: "projecte",
  ...
  { id: "post-nano-banana-vidre-1",
    town_id: 1,
    author: "IAIA MarIA",
    author_avatar: "/assets/avatars/nano_banana_comic.png",
    ...
    likes: 840,
    comments: 112,
    image_url: ["/assets/avatars/nano_banana_vidre_1774195043000.png"],
    type: "post",
  ...
  { id: "post-beatriz-escola-1",
    town_id: 1,
    author: "Andreu Soler",
    author_avatar: "/assets/avatars/beatriz_ortega_comic.png",
    author_role: "ambassador",
    ...
    comments: 21,
    image_url: [
      "/assets/avatars/post_beatriz_escola.png",
      "/assets/avatars/beatriz_somriure_1774195114538.png",
      "/assets/avatars/beatriz_xiquets_1774195132098.png"
    ],
    type: "post",
  ...
  { id: "post-gall-meteo-1",
    ...
    author_avatar: "/assets/avatars/avatar_marc_comic.png",
    author_role: "ambassador",
    ...
    likes: 890,
    comments: 45,
    image_url: ["/assets/brand/post_gall_meteo.png"],
    type: "post",
  ...
  { id: "post-carla-salut-1",
    ...
    likes: 210,
    comments: 14,
    image_url: ["/assets/brand/post_carla_salut.png"],
    type: "post",
  ...
  { id: "post-pepica-cuina-1",
    ...
    author_avatar: "/assets/brand/pepica_vall_comic.png",
    author_role: "ambassador",
    ...
    likes: 1040,
    comments: 89,
    image_url: ["/assets/brand/post_pepica_cuina.png"],
    type: "post",
  ...
  { id: "post-mixa-qa-1",
    ...
    likes: 125,
    comments: 10,
    image_url: ["/assets/avatars/nano_mixa_qa.png"],
    type: "post",
  ...
  { id: "post-flash-opt-1",
    town_id: 1,
    author: "Flash",
    author_avatar: "/assets/brand/flash_comic.png",
    author_role: "ambassador",
    ...
    likes: 580,
    comments: 34,
    image_url: ["/assets/avatars/nano_flash_fibra.png"],
    type: "post",
  ...
  { id: "post-ratoli-datos-1",
    town_id: 1,
    author: "Súper Ratolí",
    author_avatar: "/assets/products/avatar_ratoli_comic.png",
    author_role: "ambassador",
    ...
    likes: 212,
    comments: 16,
    image_url: ["/assets/products/nano_ratoli_dades.png"],
    type: "post",
  ...
  { id: "post-sultan-did-1",
    town_id: 1,
    author: "Sultan",
    author_avatar: "/assets/brand/sultan_comic.png",
    author_role: "ambassador",
    ...
    likes: 720,
    comments: 42,
    image_url: ["/assets/avatars/nano_sultan_lleis.png"],
    type: "post",
  ...
  { id: 900,
    ...
    image_url: ["/assets/events/nano_crema_agricola_1774195433973.png"],
    
    image_url: ["/assets/avatars/tramit_nano_v2.png"],
    official: true,
  ...
  { id: 1100,
    ...
    image_url: [
      "/assets/events/nano_mercat_llaurador_1774197050578.png",
    ],
  ...
  { id: 901,
    ...
    image_url: ["/assets/avatars/nano_cooperativa_xilella_1774195451171.png"],
  ...
  { id: "blog-rentonar",
    ...
    town_name: "Sella",
    author: "Marc (El Gall)",
    author_avatar: "/assets/brand/elena_popova_comic.png",
    author_role: "user",
    ...
    image_url: [
      "/assets/places/nano_elena_rentonar.png",
    ],
  ...
  { id: "blog-rentonar-2",
    ...
    image_url: [
      "/assets/places/nano_rentonar_sega_1774196023321.png",
    ],
  ...
  { id: "guia-convivencia-final",
    ...
    comments: 110,
    image_url: [
      "/assets/avatars/nano_sultan_lleis.png",
    ],
    type: "post",
    source_type: "official",
  ...
  { id: "utilitat-social-primaria",
    ...
    comments: 245,
    image_url: [
      "/assets/avatars/nano_cor_comarca.png",
    ],
    type: "post",
    source_type: "iaia",
  ...
  { id: "iaia-whatsapp-difusio",
    ...
    likes: 950,
    comments: 112,
    image_url: ["/assets/brand/master_notebooklm_nexus.png"],
  ...
  { id: "smart-villages-master-presentation",
    ...
    comments: 92,
    image_url: [
      "/assets/avatars/nano_botiguer_smart.png",
    ],
  ...
  { id: "andreu-forja-post",
    ...
    author: "Vicent Ferris",
    author_avatar:
      "/assets/brand/andreu_soler_comic.png",
    author_role: "user",
    time: "1h",
    ...
    comments: 12,
    image_url: [
      "/assets/events/nano_forja_ferro.png",
    ],
    type: "post",
    source_type: "unknown",
  ...
  { id: "iaia-guia-mobil",
    ...
    likes: 890,
    comments: 45,
    image_url: ["/assets/avatars/iaia_guiding_family_mobile.png"],
    type: "didactic_presentation",
    metadata: {
  ...
  { id: "vicent-workshop-didactic",
    town_id: 1,
    author: "Marc (El Gall)",
    author_avatar: "/assets/events/vicent_workshop.png",
    author_role: "user",
    time: "Ara",
  ...
  { id: "infografia-arrels",
    ...
    town_name: "La Torre de les Maçanes",
    author: "IAIA MarIA",
    author_avatar: "/assets/brand/joan_batiste_comic.png",
    author_role: "user",
    author_entity_id: "11111111-1a1a-0000-0000-000000000000",
    time: "1h",
    ...
    likes: 245,
    comments: 18,
    image_url: ["/assets/avatars/nano_arxiver_arrels.png"],
    type: "didactic_presentation",
    metadata: {
  ...
  { id: "rentonar-oficial-post",
    ...
    comments: 15,
    image_url: [
      "/assets/places/nano_rentonar_arquitectura_1774196001924.png",
    ],
    type: "didactic_presentation",
    metadata: {
  ...
  { id: "anna-calvo-presentation",
    ...
    town_name: "La Torre de les Maçanes",
    author: "Beatriz Ortega",
    author_avatar: "/assets/avatars/avatar_samir_comic.png",
    author_role: "user",
    author_entity_id: "11111111-1a1a-0001-0000-000000000002",
    time: "3h",
    ...
    comments: 12,
    image_url: [
      "/assets/avatars/nano_viatjant_presentacio.png",
    ],
    type: "didactic_presentation",
    metadata: {
  ...
  { id: "joia-mercat-1",
    ...
    author: "Vicent Ferris",
    author_avatar:
      "/assets/avatars/nano_rebost_1774192095512.png",
  ...
  { id: "joia-agenda-1",
    ...
    image_url: [
      "/assets/avatars/nano_rato_calendari.png",
    ],
  ...
  { id: "joia-mapa-1",
    ...
    image_url: [
      "/assets/products/nano_figuera_frut_1774197087933.png",
    ],
  ...
  { id: 11,
    ...
    author: "Marc (El Gall)",
    author_avatar:
      "/assets/brand/vicent_ferris_comic.png",
    author_role: "ambassador",
    author_entity_id: "11111111-0000-0000-0000-000000000004",
    time: "2d",
    content:
    ...
    likes: 28,
    comments: 2,
    image_url: ["/assets/places/nano_porta_masia_roure_1774195469079.png"],
    lat: 38.6212,
    lng: -0.4447,
  ...
  { id: 4,
    ...
    likes: 15,
    comments: 2,
    image_url: ["/assets/places/nano_biblioteca_muro_1774195499415.png"],
    lat: 38.6443,
    lng: -0.3862,
    created_at: new Date(Date.now() - 86400000).toISOString(),
    author_name: "IAIA MarIA",
  ...
  { id: "sollutia-pilar-1",
    ...
    comments: 890,
    image_url: [
      "/assets/avatars/nano_rhizome_sobirana_1774235342885.png",
    ],
    type: "post",
    is_pinned: true,
    pinned_position: 2,
  ...
  { id: "sollutia-pilar-2",
    ...
    comments: 45,
    image_url: [
      "/assets/events/nano_olleta_alcoi_1774235360622.png",
    ],
    type: "post",
    lat: 38.6186,
    lng: -0.4259,
...
export const MOCK_MARKET_ITEMS = [
  // Sóc de Poble (Oficial) - MAROON EDITION FIRST
  {
    ...
    official: false,
    images: [
      "/assets/products/mel_nano_v2.png",
    ],
  ...
  },
  {
    ...
    official: true,
    images: [
      "/assets/products/oli_nano_v2.png",
    ],
    category_slug: "producte-local",
    lat: 38.6504,
    lng: -0.4628,
  ...
  },
  {
    ...
    pinned: true,
    images: [
      "/assets/products/samarreta-soc-de-poble.png",
      "/assets/products/camiseta_nano_oficial.jpg",
      "/assets/products/camiseta_nano_detall.png",
    ],
    category_slug: "roba",
    tag: "Merchandising",
    is_pinned: true,
  ...
  },
  {
    ...
    price: "180€",
    image: "/assets/products/oli_nano_v2.png",
    image: "/assets/products/mel_nano_v2.png",
    seller: "Vicent Ferris",
    avatar_url: "/assets/avatars/avatar_man_old.png",
    author_role: "ambassador",
    author_entity_id: "11111111-0000-0000-0000-000000000004",
    image: "/assets/events/vicent_workshop.png",
  ...
  },
  {
    ...
    tag: "Serveis Rurals",
        image: "/assets/places/nano_pedra_seca.png",
    lat: 38.5888,
    lng: -0.3844,
  ...
  },
  {
    ...
    author_entity_id: "11111111-1a1a-0001-0000-000000000001",
    image:
      "/assets/avatars/nano_herbero_mariola.png",
    category_slug: "artesania",
    tag: "Artesania",
    lat: 38.5799,
    lng: -0.3914,
  ...
  // Muro
  {
    ...
    cover:
      "/assets/avatars/nano_banana_comic.png",
    count: 5,
    type: "memory",
    images: [
      "/assets/avatars/nano_banana_comic.png",
      "/assets/products/avatar_ratoli_comic.png",
      "/assets/brand/flash_comic.png",
      "/assets/avatars/iaia_comic_rebost.png",
      "/assets/avatars/iaia_comic_matriarch.png",
    ],
    lat: 38.5666,
    lng: -0.4384,
...
export const MOCK_EVENTS = [
  { id: 301,
    ...
    tags: ["Cultura", "Danses", "Tradició"],
        image_url: ["/assets/events/nano_aplec_danses.png"],
    lat: 38.5985,
    lng: -0.3863,
  ...
  { id: 302,
    ...
    tags: ["Oficial", "Plens", "Ajuntament"],
        image_url: ["/assets/events/nano_socis_tecnologics_1774235328704.png"],
    lat: 38.6458,
    lng: -0.3974,
...
export const MOCK_TOWNS = [
  ...
  { id: 402,
    ...
    image: true,
    image_url:
      "/assets/places/nano_benifallim.png",
    lat: 38.6439,
    lng: -0.4632,
  ...
  { id: 404,
    ...
    linkTo: "Gent de Sella",
        image_url: "/assets/places/nano_sella.png",
    lat: 38.6083,
    lng: -0.2721,
  ...
  { id: 406, type: "town", author: "Gent de Relleu", avatar: "🫒", time: "Local", title: "Relleu",
    post_subtitle: "Un racó ple d\'història i vida", content: "El mirador històric de la Marina.", population: "1200 hab", linkTo: "Gent de Relleu", image_url: "/assets/places/nano_relleu.png", lat: 38.5878, lng: -0.3114, created_at: "2026-03-08T08:00:00.000Z", },
  { id: 407, type: "town", author: "Gent d'Alcoleja", avatar: "🌰", time: "Local", title: "Alcoleja",
    post_subtitle: "Un racó ple d\'història i vida", content: "Poble bonic als peus d'Aitana.", population: "170 hab", linkTo: "Gent d'Alcoleja",     image_url: "/assets/places/nano_alcoleja.png",
  ...
  { id: 408, type: "town", author: "Gent de Xixona", avatar: "🍯", time: "Local", title: "Xixona",
    post_subtitle: "Un racó ple d\'història i vida", content: "El bressol mundial del torró.", population: "6800 hab", linkTo: "Gent de Xixona",     image_url: "/assets/places/nano_xixona.png",
  ...
  { id: 409, type: "town", author: "Gent de Tibi", avatar: "🌊", time: "Local", title: "Tibi",
    post_subtitle: "Un racó ple d\'història i vida", content: "El pantà més antic d'Europa en ús.", population: "1700 hab", linkTo: "Gent de Tibi",     image_url: "/assets/places/nano_tibi.png",
