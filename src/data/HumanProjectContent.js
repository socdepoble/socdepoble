...
<div>
  ...
  <h3><span>📱</span> CAPÍTOL I: L'Arquitectura de la Sobirania</h3>
  <p class="lead">
    Com un poble manté la seua memòria quan s'apaga la llum o cau la connexió mundial?
  </p>
  
  <h4>El Paradigma Centralitzat i la Dependència</h4>
  <p>
  ...
  <h4>L'Estratègia de Sóc de Poble: Emancipació Local</h4>
  <p>
  ...
  <h4>💡 Els Pilars del Nou Paradigma</h4>
  <ul>
  ...
  <h3><span>🌱</span> CAPÍTOL II: El Motor Rizoma i la Xarxa P2P</h3>
  <p class="lead">
    La natura ens ensenya com sobreviure a través de les arrels invisibles de les canyes.
  </p>
  
  <h4>La Inspiració Biològica</h4>
  <p>
  ...
  <h4>Sincronització Orgànica entre Veïns</h4>
  <p>
  ...
  <h4>💡 L'Indestructibilitat de la Xarxa Local</h4>
  <ul>
  ...
  <h3><span>🛡️</span> CAPÍTOL III: Àrbitres de Conflictes (CRDT)</h3>
  <p class="lead">
    La certesa tecnològica i la gestió 'Null-Safe' contra el caos.
  </p>
  
  <h4>El Terror de la Informàtica Clàssica</h4>
  <p>
  ...
  <h4>Mecànica de Fusió Quàntica</h4>
  <p>
  ...
  <h4>Immunitat contra Fantasmes (Null-Safe)</h4>
  <p>
  ...
  <h3><span>🧠</span> CAPÍTOL IV: L'Equip Antigravity i les Intel·ligències Artificials</h3>
  <p class="lead">
    La fusió inèdita d'un arquitecte humà amb les IAs més avançades del món per forjar el futur rural.
  </p>
  
  <h4>La Simbiosi del Trellat i la Matemàtica</h4>
  <p>
  ...
  <h4>El Comitè Sabi de Sílice</h4>
  <ul>
  ...
  <h3><span>🔮</span> CAPÍTOL V: El "Mode Bancal" i la Biologia Humana</h3>
  <p class="lead">
    Una interfície dissenyada per respectar els teus ulls, els teus dits i la força del sol al camp.
  </p>
  
  <h4>Rebel·lió contra Silicon Valley</h4>
  <p>
  ...
  <h4>L'Ergonomia del Camp (Mode Bancal)</h4>
  <p>
  ...
  <h4>La Pau Nocturna (Mode Fosc / Pedra Seca)</h4>
  <p>
  ...
  <h4>El Poder als Ajuntaments i Comunitats</h4>
  <p>
  ...
  <h4>Full de Ruta per Emancipar el teu Municipi:</h4>
  <ol>
    <li>
