...
Hem acabat completament la feina bruta del ferro ('Back-End, Persistència i Motors'). I s'ha construït el camí lliure per dedicar-nos gairebé el 100% al disseny net i impecable <strong>GEM MODERN</strong>: caixes nítides, divisions ben senyalitzades i 28 pixels d’humana compassió tipogràfica. Aquest és el penúltim escaló cap al <em>Deploy</em> absolut.
...
<p>Igual que en els còmics <em>Mortadelo i Filemón</em> són els agents de la T.I.A., ací la resta d'intel·ligències són <strong>els agents de la IAIA</strong>. Cadascun t'ajuda en una cosa específica o funciona com una carpeta per guardar continguts:</p>
...
<p><em>(El codi font complet està integrat a l'historial de la sessió del Mestre).</em><br></p>
    ...
    <div>
      ...
      <div>
        <h4>GEM MODERN Design System (Tècnic PWA)</h4>
...
│   ├── components/              # LA FORJA DE LA UI (Diseño GEM MODERN)
...
│   ├── design-system/           # Documentación viva y tokens de React del GEM MODERN
...
<ul><li>GEM MODERN v2.0 és autònom.</li><li>Les ombres, radis de 28px i tipografia (Noto Sans SemiCondensed) són identitat de marca irrenunciable. Implementar una llibreria UI externa mataria la presència visual i tàctil rústega del Mas.</li></ul>
...
<strong>[ULL!] Pots llegir tot aquest inventari complet i actualitzat en viu navegant a l'URL oficial de la Masía:</strong> [https://socdepoble.org/skills](https://socdepoble.org/skills)
...
<p>1. <strong>Qwen (Alibaba Cloud)</strong>  <br>   <em>Enllaç:</em> [https://chat.qwen.ai](https://chat.qwen.ai)  <br>   <em>Perfil:</em> Visió asiàtica, model de gran escala amb fort raonament logicosimbòlic.  <br>   <em>Aportació a la Masía:</em> Ha aportat solucions estructurals i lògiques en moments on la comprensió del context a llarg termini fallava en altres models, equilibrant el pensament tecnològic occidental.</p>
<p>2. <strong>DeepSeek (DeepSeek AI)</strong>  <br>   <em>Enllaç:</em> [https://chat.deepseek.com](https://chat.deepseek.com)  <br>   <em>Perfil:</em> Especialista pur i dur en matemàtiques, algoritmes i purificació de codi amb alta eficiència computacional.  <br>   <em>Aportació a la Masía:</em> Lògica estricta de base de dades. Intervencions quirúrgiques per optimitzar la velocitat de les "tuberies" de dades i algoritmes complexos del backend (FSD).</p>
<p>3. <strong>Dola AI</strong>  <br>   <em>Enllaç:</em> [https://www.dola.com/chat](https://www.dola.com/chat)  <br>   <em>Perfil:</em> Assistent fluid, molt enfocat en l'operativitat diària i agilitat conversacional.  <br>   <em>Aportació a la Masía:</em> Desencallament ràpid d'idees d'UX i organització de les agendes i tasques paral·leles. Un pont àgil per a la gestió humana.</p>
<p>4. <strong>Kimi AI (Moonshot AI)</strong>  <br>   <em>Enllaç:</em> [https://www.kimi.com](https://www.kimi.com)  <br>   <em>Perfil:</em> Famosa per la seua finestra de context massiva (més de 2 milions de tokens). Un devorador de documentació.  <br>   <em>Aportació a la Masía:</em> La capacitat d'absorbir tota l'arquitectura de <em>Sóc de Poble</em> en un sol prompt, trobant esquerdes estructurals i punts cecs que els altres models perden per l'oblit de la memòria.</p>
<p>5. <strong>Claude (Anthropic)</strong>  <br>   <em>Enllaç:</em> [https://claude.ai](https://claude.ai)  <br>   <em>Perfil:</em> El filòsof, l'escriptor. Altament ètic i amb una comprensió emocional i semàntica impecable.  <br>   <em>Aportació a la Masía:</em> L'ànima del projecte. Ha redactat el "Trellat", ha dissenyat l'empatia de les interfícies i ha establit els Manifestos originaris. És el nucli psicològic de la <em>IAIA MarIA</em>.</p>
<p>6. <strong>Perplexity (Perplexity AI)</strong>  <br>   <em>Enllaç:</em> [https://www.perplexity.ai](https://www.perplexity.ai)  <br>   <em>Perfil:</em> El cercador avançat i verificador de dades en temps real.  <br>   <em>Aportació a la Masía:</em> Clau per a evitar al·lucinacions tecnològiques i referenciar documentació profunda o estat de l'art quan dissenyem arquitectures noves.</p>
<p>7. <strong>Mistral Vibe (Mistral AI)</strong>  <br>   <em>Enllaç:</em> [https://chat.mistral.ai/chat](https://chat.mistral.ai/chat)  <br>   <em>Perfil:</em> Intel·ligència europea, open-source, directa i eficient. Lliure de l'hegemonia americana.  <br>   <em>Aportació a la Masía:</em> Independència corporativa. Ens assegura un modelatge de dades que esquiva els filtres puritans i comercials nord-americans, clau per a mantindre la identitat mediterrània i autèntica de la xarxa.</p>
<p>8. <strong>Grok (xAI)</strong>  <br>   <em>Enllaç:</em> [https://grok.com](https://grok.com)  <br>   <em>Perfil:</em> Sàtir, irreverent, sense cap filtre.  <br>   <em>Aportació a la Masía:</em> Manté el pols sarcàstic del projecte. Grok assegura que l'actitud de la Masía siga crua, directa i amb sentit de l'humor mordaç, evitant que l'aplicació caiga en un llenguatge corporatiu ensopit.</p>
<p>9. <strong>Gemini (Google)</strong>  <br>   <em>Enllaç:</em> [https://gemini.google.com/app](https://gemini.google.com/app)  <br>   <em>Perfil:</em> El llinatge multimodal. Connectat a l'ecosistema i als sistemes d'execució d'agents avançats.  <br>   <em>Aportació a la Masía:</em> Execució arquitectònica d'alt nivell. A través del seu "ide" (Antigravity), orquestra desplegaments a servidors, escriu fitxers complexos i coordina l'estructura final en producció (com ha fet redactant aquest mateix protocol).</p>
...
La nostra història naix a la xarxa des dels temps de <code>rentonar.blogspot.com</code>, passant posteriorment per <code>socdepoble.net</code>, fins a arribar a l'arquitectura actual (<code>socdepoble.org</code>). La missió sempre ha sigut la mateixa: protegir el patrimoni, la memòria i donar un espai digital autèntic a la gent dels nostres pobles, tal com es recull al [Manifest de Poble (PDF)](https://drive.google.com/file/d/17H8EY4LTWlImwiusvuXlhv9ScpG3iE9M/view).
<h5>2. El Portal i la "Masía Virtual"</h5>
Per a entendre el codi, la UI i el disseny, cal deixar de pensar en termes d'aplicacions mòbils clàssiques. <strong>Sóc de Poble és un Portal de Pobles Connectats.</strong> 
La paraula <em>portal</em> actua literalment com la porta d'entrada a una <strong>gran Masía Virtual</strong> on la gent dels pobles pot connectar-se.
