export const IAIA_RURAL_KNOWLEDGE = {
  ...
  proverbs: ["A la vora del riu, no faces niu.", "Cel a borreguets, aigua a canterets.", "A l'octubre, l'ombra abriga.", "Home de molts oficis, pobre de tots vicis."],
  music: {
    groups: [{
      name: "Auxili",
      origin: "Ontinyent",
      ...
      image_url: "https://images.unsplash.com/photo-1549412639-66172551000f?q=80&w=2070&auto=format&fit=crop",
      // Roots/Reggae vibe related to Mediterranean
...
export const RESIDENT_LORE = {
  "Vicent Ferris": {
    ...
    avatar_url: "/uploads/avatars/avatar_man_old.png"
  },
  "Samir Mensah": {
    ...
    avatar_url: "/uploads/avatars/avatar_man_1.png"
  },
  ...
  "Tio Colau": {
    ...
    avatar_url: "/uploads/avatars/tio-colau-comic.png"
  },
  "Nano Banana": {
    ...
    avatar_url: "/uploads/avatars/nano-banana.png"
  },
  "L'Avi dels Papers": {
    ...
    avatar_url: "/uploads/avatars/avi_papers.png"
  }
};