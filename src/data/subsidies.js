...
export const MOCK_SUBSIDIES = [{
  ...
  deadline: "31/12/2024",
  status: "oberta",
  requirements: ["Ser autònom o empresa d'entre 0 i 3 treballadors.", "Estar al corrent de les obligacions tributàries i amb la Seguretat Social.", "No tindre la consideració d'empresa en crisi."],
  ...
  deadline: "15/05/2026",
  status: "proximament",
  requirements: ["Ser agricultor actiu.", "Disposar de drets de pagament bàsic.", "Complir les pràctiques de 'Greening' (ecotransició)."],
  ...
  deadline: "30/09/2026",
  status: "oberta",
  requirements: ["Instal·lació de plaques solars en naus industrials o habitatges.", "Auditoria energètica prèvia."],
  ...
  deadline: "10/03/2026",
  status: "oberta",
  requirements: ["Ser PIME industrial de les nostres comarques.", "Realitzar inversions en actius materials o immaterials.", "Mantenir l'ocupació durant 3 anys."],
  ...
  deadline: "31/03/2026",
  status: "oberta",
  requirements: ["Projectes de recerca industrial o desenvolupament experimental.", "Pressupost elegible entre 50.000€ i 175.000€.", "Execució fins al juny de 2027."],
  ...
  deadline: "14/04/2026",
  status: "oberta",
  requirements: ["Consorci europeu de socis.", "Projectes d'investigació i innovació (RIA).", "Enfocament en competitivitat sostenible i repte demogràfic."],
  description: "Convocatòria HORIZON-CL6-2026-02-COMMUNITIES-01. Busca enfortir les economies rurals i millorar l'accés a serveis mitjançant innovació comunitària.",
  iaia_advice: "Aquesta és la Champions League, Mestre! Si ens unim a una universitat o un institut tecnològic, el 'Mercat Rural Directe' podria ser el pilot estrella d'Europa.",
  ...
  status: "proximament",
  requirements: ["Projectes en zones rurals gestionats per GAL.", "Inversions inmaterials (software, consultoria).", "Foment de l'economia de proximitat i patrimoni cultural."],
  description: "Fons per al desenvolupament rural participatiu. Ideal per a la implementació local de la tecnologia Sóc de Poble en comarques de l'interior.",
  iaia_advice: "Els GAL de la zona ens coneixen bé. Si presentem la nostra tecnologia com un servei bàsic pel veïnat, el LEADER ens donarà l'embranzida final.",
  official_link: "https://agricultura.gva.es"
}, {
  id: "irpf-social-2026",
  ...
  status: "proximament",
  requirements: ["Entitats del Tercer Sector (associacions sense ànim de lucre).", "Projectes d'inclusió social o atenció a persones majors.", "Memòria justificativa de l'impacte en el territori."],
  description: "Convocatòria per a finalitats d'interès social a càrrec del 0,7% de l'IRPF. Inclou la modalitat 'Teixit Social de Base'.",
  iaia_advice: "Mestre, aquí és on la 'Memòria Viva' i el combat a la bretxa digital de la tercera edat brillen més. Som el projecte ideal per a Benestar Social!",
  ...
  status: "oberta",
  requirements: ["PIMEs o entitats del tercer sector.", "Integració en espais de dades sectorials segurs.", "Adquisició de maquinari assegurat (Novedat 2026)."],
  description: "Finançament per a infraestructura tecnològica base i integració en ecosistemes de dades. Inclou ciberseguretat i equips segurs.",
  iaia_advice: "La nostra sobirania digital demana 'ferros' segurs. Amb el Kit podem finançar els portàtils i el bosc de dades sense posar ni un cèntim.",
  ...
  status: "proximament",
  requirements: ["Entitats sense ànim de lucre en municipis de < 5.000 hab.", "Innovació social i transformació territorial.", "Lluita contra la despoblació i atenció rural."],
  description: "Subvencions del Ministeri per a la Transició Ecològica per a projectes innovadors contra la despoblació rural.",
  iaia_advice: "Això és exactament el que som: l'arquetip del repte demogràfic. Tenim tot el 2026 per a polir el dossier i entrar amb força al MITECO.",
