...
const macros = {
  ...
  {
    spriteKey: 'sausage',
    rootQuery: '#sausage-wrapper',
    sequenceName: 'overload',
    offset: 0
  },
  // Píxel reacciona una mica després
  {
    spriteKey: 'pixel',
    rootQuery: '#pixel-wrapper',
    sequenceName: 'mischief',
    offset: 300
  },
  // Ratolí solda i fa sparks
  {
    spriteKey: 'rat',
    rootQuery: '#rat-wrapper',
    sequenceName: 'panic',
    offset: 420
  },
  // Worm expulsa bits
