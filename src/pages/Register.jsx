    ...
    <div className="auth-container premium-onboarding">
      ...
      <div className="auth-card register-card-v2 animate-in-up">
        ...
        <header className="auth-header glass-header">
          ...
          <div
            className="auth-iaia-guidance interstellar-iaia"
          ...
          >
            ...
            <div className="iaia-speech-bubble-interstellar">
              {step === "identity"
                ? focusedField === "name"
                  ? "Posa el teu nom tal com vols que et coneguen al poble, bonico! ✨"
        ...
        <div className="auth-footer-v2">
          {step !== "welcome" && (
            <p>
              Ja tens compte? <Link to="/login">Entra ara</Link>
            </p>
          )}
        </div>
      </div>
      ...
      <footer className="onboarding-legal">
        <p>
          En bategar, acceptes que Sóc de Poble és un experiment de sobirania
          digital. <Link to="/legal">Avisos Legals</Link>
        </p>
        <div
          className="auth-version-footer"
          style={{
            marginTop: "10px",
            opacity: 0.3,
            fontSize: "0.7rem",
