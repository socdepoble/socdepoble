...
const Towns = () => {
  ...
  const { selectedTown } = useNavigation();
  ...
  const filteredEvents = useMemo(() => {
    return MOCK_EVENTS.filter((event) => {
      ...
      const matchesTag =
        activeEventTag === "tots" || event.tags.includes(activeEventTag);
      ...
      <div className="towns-content-area">
        ...
        {currentTab === "esdeveniments" && (
          <div className="events-container">
            ...
            >
              <div
                className="event-tags-selector flex gap-2 overflow-x-auto pb-2"
