...
import MedicationManager from '../features/medication/MedicationManager';

import FallDetectionToggle from '../features/safety/FallDetectionToggle';

const VitalSecurity = () => {

    return (
        <div className="flex h-screen w-full flex-col bg-[var(--background-color)]">
            <ContextualHeader 
                title="Àngels de la Guarda"
                backUrl="/mur"
            />
            ...
            <div className="flex flex-1 flex-col overflow-y-auto p-4 custom-scrollbar padding-bottom-safe">
                <div className="mx-auto w-full max-w-2xl px-2 py-6 flex flex-col gap-8">
                    ...
                    <div className="animate-in slide-in-from-bottom-4 duration-500 fade-in delay-200 flex flex-col gap-4 rounded-3xl bg-[var(--surface-color)] p-6 shadow-sm ring-1 ring-red-500/20">
