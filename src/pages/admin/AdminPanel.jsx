...
const AdminPanel = () => {
  ...
  useEffect(() => {
    ...
    const bootSystem = async () => {
      ...
      try {
        // Parallel Fetching
        const [sData, seoData] = await Promise.all([supabaseService.getAdminStats(), supabaseService.getSEOStats()]);
      ...
      <div className="admin-container">
                ...
                opacity: 0.5
                    ...
                    <div className="flex gap-2">
                        <button onClick={() => window.dispatchEvent(new CustomEvent('open-diagnostic-hud'))} className="header-diagnostic-btn" title={t('nav.support')}>
                ...
                <div className="admin-content">
                    ...
                    {!activeModule ? <div className="dashboard-layout">
                            ...
                            <div className="left-col gap-6 flex flex-col">
                                ...
                                <div className="system-logs">
                                    <div className="flex justify-between items-center mb-2 border-b border-gray-800 pb-1">
                                        TERMINAL D'OPERACIONS
                                        <Terminal size={12} />
                                    </div>
                                    {logs.map(log => <div key={log.id} className={`log-entry ${log.type}`}>
                            ...
                            <div className="modules-grid">
                                <h4 className="text-xs opacity-40 font-bold mb-2 uppercase tracking-widest pl-2">Accés Directe</h4>
                ...
                try {
                  ...
                  color: '#fff'
                                ...
                                <div className="module-card gold" onClick={() => setActiveModule('roadmap')} style={{
                ...
                boxShadow: '0 0 15px rgba(255, 0, 255, 0.2)'
                  ...
                  color: '#fff'
                                ...
                                <div className="module-card gold" onClick={() => setActiveModule('memex')} style={{
                ...
                borderStyle: 'dashed'
                  ...
                  color: '#000'
                                ...
                                {/* MODULE 7: STORES (New) */}
                                <div className="module-card status-active" onClick={() => setActiveModule('stores')} style={{
                borderColor: 'var(--color-primary)',
                borderStyle: 'double'
              }}>
                                    <div className="module-icon-wrapper" style={{
                  ...
                  color: '#000'
                                ...
                                {isSuperAdmin && <div className="module-card cyan" onClick={() => setActiveModule('super-raton')} style={{
                borderColor: 'var(--hud-accent)',
                boxShadow: '0 0 15px rgba(0, 242, 255, 0.2)'
                  ...
                  color: '#000'
                                ...
                                {isSuperAdmin && <div className="module-card status-active" onClick={() => setActiveModule('zeroday')} style={{
                borderColor: 'var(--color-primary)',
                boxShadow: '0 0 15px rgba(0, 122, 255, 0.2)'
                  ...
                  color: '#fff'
                                ...
                                {isSuperAdmin && <div className="module-card status-active" onClick={() => setActiveModule('utilitat-social')} style={{
                ...
                boxShadow: '0 0 15px rgba(34, 197, 94, 0.2)'
                  ...
                  color: '#fff'
                                ...
                                {isSuperAdmin && <div className="module-card gold" onClick={() => setActiveModule('memory-governance')} style={{
                borderColor: 'var(--color-warning)',
                ...
                overflow: 'hidden'
                  ...
                  color: '#000'
                                ...
                                {isSuperAdmin && <div className="module-card blue" onClick={() => setActiveModule('marketing')} style={{
                borderColor: 'var(--color-primary)',
                boxShadow: '0 0 15px rgba(0, 242, 255, 0.2)'
              }}>
                                        <div className="module-icon-wrapper" style={{
                  ...
                  color: '#000'
                                ...
                                {isSuperAdmin && <div className="module-card red" onClick={() => setActiveModule('editorial-governance')} style={{
                ...
                boxShadow: '0 0 15px rgba(239, 68, 68, 0.2)'
                  ...
                  color: '#fff'
                                ...
                                {isSuperAdmin && <div className="module-card blue" onClick={() => setActiveModule('permissions')} style={{
                borderColor: 'var(--color-primary)',
                boxShadow: '0 0 15px rgba(0, 122, 255, 0.2)'
              }}>
                                        <div className="module-icon-wrapper" style={{
                  ...
                  color: '#fff'
                        ...
                        </div> : (/* VIEW: ACTIVE MODULE RENDERER */
...
const BroadcastModule = ({
  ...
  return <div className="neural-core-panel" style={{
    minHeight: '400px'
  }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 border border-gray-700 rounded-[28px] bg-black/20">
                    ...
                    <div className="flex flex-col gap-2">
                        <button className="btn-primary w-full" style={{
            background: 'var(--color-warning)'
          }} onClick={handleGlobal}>
                            {sending ? 'EXECUTANT...' : 'INICIAR GLOBAL BROADCAST'}
                        </button>
                        <button className="btn-primary w-full mt-2" style={{
            background: 'var(--hud-accent)',
            color: '#000'
          }} onClick={handleRestoreArchives}>
                            <ArrowLeft size={16} className="inline-block mr-1" />
                            RESTAURAR ARXIU HISTÒRIC (WP/BLOGGER)
                        </button>
                        <button className="btn-primary w-full mt-8" style={{
            background: 'var(--color-error)'
          ...
          try {
            const {
              publishAnnaNews
            } = await import('../../utils/publishAnnaNews');
    ...
    minHeight: '400px'
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="vitality-meter-wrapper">
                            ...
                            <div className="h-2 w-full bg-gray-800 rounded-[28px] overflow-hidden">
                                <div className="h-full bg-green-500 shadow-[0_0_10px_#22c55e]" style={{
                width: `${socialVitality}%`
              }}></div>
                            </div>
                        </div>
            ...
            <div className="mt-6 p-4 bg-gray-900/50 rounded-[28px] border border-gray-800">
                ...
                <div className="flex flex-wrap gap-2">
                    <button className="btn-hud-small text-xs" onClick={() => navigate('/dafo/utilitat-social')}>DAFO UTILITAT</button>
                    <button className="btn-hud-small text-xs" onClick={() => navigate('/dafo/iaia')}>DAFO IAIA</button>
                    <button className="btn-hud-small text-xs" onClick={() => navigate('/dafo/projecte')}>DAFO PROJECTE</button>
                </div>
            </div>
...
const MemoryGovernanceModule = ({
  ...
  const runJSONBackup = async () => {
    ...
    if (now - lastBackupTime < 60000) {
      // 1 Minut Rate Limit per previndre RLS abús i SPAM
    ...
    try {
      ...
      const {
        data,
        error
      } = await supabaseService.client.functions.invoke('backup-sobirania', {
        method: 'POST'
      });
      if (error) {
  ...
  return <div className="neural-core-panel" style={{
    minHeight: '400px'
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div className="p-2 bg-gray-900 rounded-[20px] text-center">
                                ...
                                <span className="text-xs opacity-50">XATS (AGENTS)</span>
                            </div>
                            <div className="p-2 bg-gray-900 rounded-[20px] text-center">
                                <span className="block text-xl font-bold">{vaultStats.mur}</span>
                                <span className="text-xs opacity-50">POSTS MUR</span>
                            </div>
                            <div className="p-2 bg-gray-900 rounded-[20px] text-center">
                                <span className="block text-xl font-bold">{vaultStats.mercat}</span>
                                <span className="text-xs opacity-50">PRODUCTES</span>
                            </div>
                            <div className="p-2 bg-gray-900 rounded-[20px] text-center">
                                <span className="block text-xl font-bold">{vaultStats.towns}</span>
                                <span className="text-xs opacity-50">POBLES</span>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
            ...
            background: 'var(--color-warning)',
            color: '#000'
          }} onClick={runFullRecovery} disabled={recovering}>
                ...
                <div className="p-6 border border-gray-700 rounded-[28px] bg-black/20 flex flex-col justify-between">
                    ...
                    <button className="btn-primary w-full" style={{
          background: 'var(--color-error)'
        }} onClick={runJSONBackup} disabled={recovering}>
...
const MarketingModule = ({
  ...
  return <div className="neural-core-panel" style={{
    minHeight: '800px'
            ...
            <div className="w-full bg-zinc-900 border-2 border-zinc-800 rounded-[2rem] overflow-hidden shadow-inner" style={{
      height: '700px'
    }}>
                <iframe credentialless="true" src="https://cloud.umami.is/share/lQNmqOm9PM8XD3eF" frameBorder="0" width="100%" height="100%" allowTransparency="true" title="Estadístiques Privades Administrador" className="w-full h-full">
        </iframe>
            </div>
...
const EditorialGovernanceModule = ({
  addLog
}) => {
  ...
  return <div className="neural-core-panel" style={{
    minHeight: '500px'
            ...
            <div className="flex gap-2 mb-6">
                <button className={`btn-hud-small ${view === 'posts' ? 'active' : ''}`} onClick={() => setView('posts')} style={{
        background: view === 'posts' ? 'var(--color-error)' : 'transparent'
      }}>
          
                    MUR (PINS)
                </button>
                <button className={`btn-hud-small ${view === 'market' ? 'active' : ''}`} onClick={() => setView('market')} style={{
        background: view === 'market' ? 'var(--color-error)' : 'transparent'
      }}>
            ...
            <AdminPinnedManager type={view === 'posts' ? 'post' : 'market'} onClose={() => addLog(`Configuració de pins pel ${view} bategada.`, 'success')} />
...
const PermissionsGovernanceModule = ({
  addLog
}) => {
  const [roles] = useState([{
    id: USER_ROLES.SUPER_ADMIN,
    label: 'Super Admin',
    access: 'Total (God Mode)',
    color: 'var(--hud-accent)'
  }, {
    id: USER_ROLES.ADMIN,
    label: 'Administrador',
    access: "Gestió d'Entitats",
    color: 'var(--color-primary)'
  }, {
    id: USER_ROLES.REGION_COORDINATOR,
    label: 'Coordinador Comarcal',
    access: 'Àrea',
    color: 'var(--color-warning)'
  }, {
    id: USER_ROLES.TOWN_COORDINATOR,
    label: 'Coordinador Local',
    access: 'Poble',
    color: 'var(--color-success)'
  }, {
    id: USER_ROLES.GROUP_COORDINATOR,
    label: 'Coordinador Grup',
    access: 'Grup',
    color: 'var(--color-error)'
  }, {
    id: USER_ROLES.NEIGHBOR,
    label: 'Sóc de Poble',
    access: 'Estàndard',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 border border-gray-700 rounded-[28px] bg-black/20">
                    ...
                    <div className="space-y-3">
                        {roles.map(role => <div key={role.id} className="flex justify-between items-center p-3 bg-gray-900/50 rounded-[20px] border border-gray-800">
                                <div>
                                    <div className="font-bold text-sm" style={{
                color: role.color
              }}>{role.label}</div>
                                    <div className="text-xs opacity-50 uppercase">{role.access}</div>
                                </div>
                                <button className="btn-hud-small text-xs">CONFIGURAR</button>
                            </div>)}
                    </div>
                </div>
                ...
                <div className="p-6 border border-gray-700 rounded-[28px] bg-black/20">
                    ...
                    <div className="space-y-3">
                        <div className="p-3 bg-red-900/10 border border-red-500/20 rounded-[20px]">
                            ...
                            <p className="text-xs opacity-70 mb-3">Només el Mestre i el Cercle poden elevar un usuari a Super Admin.</p>
                            <button className="btn-primary w-full bg-red-600 text-white text-xs h-8">AUDITAR ACCESOS CRÍTICS</button>
                        </div>
