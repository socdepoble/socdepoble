...
const DidacticPage = () => {
  ...
  if (!post) {
    return <div className="didactic-page-error">
  ...
  return <div className="didactic-page-container">
            <SEO title={`${post.metadata?.title || 'Lliçó Master'} - Sóc de Poble`} description={post.content.substring(0, 160)} image={post.image_url} />
      

            <div role="region" aria-label="Capçalera de Secció" className="didactic-header">
            ...
            <div role="region" aria-label="Contingut Principal" className="didactic-content">
                <div className="content-hero">
                    {post.image_url && post.image_url.length > 0 && <div className="didactic-image-wrapper">
