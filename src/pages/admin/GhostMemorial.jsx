  ...
  return (
      <div className="ghost-memorial-page bg-black min-h-screen text-white p-8">
                <div role="region" aria-label="Capçalera de Secció" className="memorial-header max-w-4xl mx-auto mb-16">
                    <button className='flex items-center gap-2 text-gray-500 hover:text-sdp-sdp-terracotta transition-colors mb-8 font-black uppercase tracking-widest text-xs' onClick={() => navigate(-1)}>
                        <ArrowLeft size={16} />
                        Retornar al Mur
                    </button>
                    ...
                    <div className="flex items-center gap-6 mb-6">
                        ...
                        <h1 className="text-5xl font-black tracking-tighter uppercase italic">
                            Memorial dels <span className='text-sdp-sdp-terracotta'>Fantasmes</span> الإلكترònics
                        </h1>
                    </div>
                    <p className='text-xl text-gray-400 font-medium leading-relaxed max-w-2xl border-l-4 border-sdp-sdp-terracotta pl-6 italic'>
                ...
                <div role="region" aria-label="Contingut Principal" className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
                    {ghosts.map(ghost => <div key={ghost.id} className="ghost-card bg-zinc-900/50 border border-zinc-800 p-8 rounded-[28px] relative overflow-hidden group data-[active=true]:border-cyan-500/50 transition-all" data-active="false" onPointerEnter={(e) => e.currentTarget.dataset.active = "true"} onPointerLeave={(e) => e.currentTarget.dataset.active = "false"} onPointerCancel={(e) => e.currentTarget.dataset.active = "false"}>
                            <div className="absolute top-0 right-0 p-4 opacity-10 group-data-[active=true]:opacity-30 transition-opacity" data-active="false" onPointerEnter={(e) => e.currentTarget.dataset.active = "true"} onPointerLeave={(e) => e.currentTarget.dataset.active = "false"} onPointerCancel={(e) => e.currentTarget.dataset.active = "false"}>
                                {ghost.icon}
                            </div>
                            <div className="ghost-status text-xs font-black tracking-[0.3em] uppercase mb-4 text-cyan-500 bg-cyan-500/10 w-fit px-3 py-1 rounded">
                                ESTAT: {ghost.status}
                            </div>
                    ...
                    <div className='ghost-card bg-gradient-to-br from-zinc-900 to-black border-2 border-dashed border-zinc-800 p-8 rounded-[28px] flex flex-col items-center justify-center text-center gap-4 group hover:border-sdp-sdp-terracotta/50 transition-all'>
                        <ShieldAlert size={48} className='text-sdp-sdp-terracotta opacity-40 group-data-[active=true]:scale-110 transition-transform' />
                ...
                <footer className="max-w-4xl mx-auto border-t border-zinc-800 pt-16 pb-32">
                    <div className="flex items-center gap-4 mb-4">
                        <Database size={24} className='text-sdp-sdp-terracotta' />
                    ...
                    <div className="bg-zinc-900/30 p-12 rounded-[28px] border border-zinc-800/50">
                        ...
                        <div className="flex gap-12 items-center">
                            <div className="flex flex-col gap-1">
                                <span className="text-xs font-black text-gray-600 uppercase tracking-widest">Versió del Protocol</span>
                                <span className="font-black text-white">Vcrit-TABULA-RASA</span>
                            </div>
                            <div className="flex flex-col gap-1">
                                <span className="text-xs font-black text-gray-600 uppercase tracking-widest">Data del darrer bategat</span>
