...
const PlaygroundPortal = () => {
  ...
  return <div className="playground-portal">
            <div role="region" aria-label="Capçalera de Secció" className="portal-header">
                ...
                <div className="ai-notice-simple">
                    <div className="ai-notice-text">
                        Interacciona amb la nostra IAIA de Poble
                    </div>
                </div>
            ...
            <div className="persona-list-container">
                {personas.map(persona => <div key={persona.id} className="persona-list-item" onClick={() => handleSelectPersona(persona)}>
                        <div className="persona-list-avatar">
                            {persona.avatar_url ? <img src={persona.avatar_url} alt={persona.full_name} className="persona-list-img" /> : <div className="persona-list-placeholder">
                                    <User size={24} />
                                </div>}
                        </div>
                        ...
                        <div className="persona-list-content">
                            <div className="persona-list-header">
                                ...
                                {persona.primary_town && <span className="persona-list-town">{persona.primary_town}</span>}
                            </div>
