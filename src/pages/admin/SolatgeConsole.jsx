...
import { rhizomeDb } from '../../core/rhizome/db-core';
...
const SolatgeConsole = () => {
  ...
  const [logs, setLogs] = useState([{
    id: 1,
    time: 'Ara',
    msg: '🚜 Benvingut a la Consola Solatge v1.0'
  }, {
    id: 2,
    time: 'Ara',
    msg: '⚡️ Protocol Batec Actiu'
  }]);
  useEffect(() => {
  ...
  return <div className="solatge-container bg-black h-full text-white animate-bategat">
            ...
            <div role="region" aria-label="Capçalera de Secció" className="solatge-header h-20 flex items-center gap-4 px-6 bg-black border-b border-gray-900 sticky top-0 z-30">
            ...
            <div className="command-center">
                <div className="console-panel">
                    ...
                    <div className="logs">
                        {logs.map(log => <div key={log.id} className="log-entry">
            ...
            showInfo('sincronitzar');
                    ...
                    <div className="action-wrapper">
                        <button className="action-btn" onClick={runIAAudit} disabled={isIAAuditLoading}>
              
                            <BrainCircuit size={24} className={isIAAuditLoading ? 'animate-spin' : ''} />
                            {isIAAuditLoading ? 'ANALITZANT...' : 'AUDITORIA IA'}
                        </button>
                    </div>
            ...
            try {
              ...
              import('../../core/services/seedService').then(async ({
                seedService
              }) => {
            ...
            showInfo('snapshot');
                    ...
                    <div className="drawer-divider" style={{
          margin: '1rem 0',
          opacity: 0.2
        }}></div>
              ...
              setTimeout(() => addLog('IAIA API: Connexió estable. Bategant a 200ms.', 'success'), 800);
                    ...
                    <div className="visual-democracy-panel">
                        <div className="panel-label">
                            <Layers size={18} />
                            DEMOCRÀCIA VISUAL (A/B)
                        </div>
                        <div className="democracy-switcher">
                            <button className={`demo-btn ${visualDemocracy === 'pedra-seca' ? 'active' : ''}`} onClick={() => {
              ...
              addLog('Estètica "Roba de Treball" (Pedra Seca) activada', 'info');
                            ...
                            <button className={`demo-btn ${visualDemocracy === 'oli-suau' ? 'active' : ''}`} onClick={() => {
