                ...
                transform: isPrivate ? 'translateX(0)' : 'translateX(100%)'
                    ...
                    <section className="mb-10">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                            {suggestedFolders.map(folder => <button key={folder.id} onClick={() => setSelectedFolder(folder.id)} className={`p-5 md:p-6 rounded-[28px] border-2 transition-all duration-300 flex flex-col items-center justify-center gap-2 relative overflow-hidden group
                                    ...
                                    `}>
                                    <span className="text-5xl md:text-6xl filter drop-shadow-md group-data-[active=true]:scale-110 group-data-[active=true]:-translate-y-1 transition-all duration-300 mb-2" data-active="false" onPointerEnter={(e) => e.currentTarget.dataset.active = "true"} onPointerLeave={(e) => e.currentTarget.dataset.active = "false"} onPointerCancel={(e) => e.currentTarget.dataset.active = "false"}>{folder.icon}</span>
                    ...
                    <div className="flex flex-col items-center justify-center pt-4">
                        <button onClick={handleSave} disabled={!selectedFolder || isSaving || isSaved} className={`
                            ...
                            {!isSaved && selectedFolder && <div className="absolute inset-0 bg-white/20 translate-y-full group-data-[active=true]:translate-y-0 transition-transform duration-300 ease-out-expo" data-active="false" onPointerEnter={(e) => e.currentTarget.dataset.active = "true"} onPointerLeave={(e) => e.currentTarget.dataset.active = "false"} onPointerCancel={(e) => e.currentTarget.dataset.active = "false"} />}
                        </button>
