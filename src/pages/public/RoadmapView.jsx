            ...
            <div className="flex items-start gap-3 mt-1">
              ...
              <div>
                <Link to={`/auditoria/llavor/${item.slug}`} className="hover:underline">
                  <h3 className='font-bold text-[1.05rem] leading-tight mb-2 text-sdp-text-main group-data-[active=true]:text-sdp-theme-accent-primary transition-colors'>{item.title}</h3>
                </Link>
...
const CalendarGanttView = () => <div className="w-full h-full flex flex-col gap-8 md:gap-14 pb-12 align-top">
    {quarters.map(q => <div key={q} className="relative w-full flex flex-col md:flex-row gap-4 lg:gap-8 items-start group" data-active="false" onPointerEnter={(e) => e.currentTarget.dataset.active = "true"} onPointerLeave={(e) => e.currentTarget.dataset.active = "false"} onPointerCancel={(e) => e.currentTarget.dataset.active = "false"}>
