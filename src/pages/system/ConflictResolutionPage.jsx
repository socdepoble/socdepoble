...
export const ConflictResolutionPage = () => {
  ...
  return <div className="min-h-screen bg-[#121212] text-[#e0e0e0] flex items-center justify-center p-6 font-sans">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-[#2a2a2a] rounded-xl p-6 border-l-4 border-emerald-500">
                        ...
                        <pre className="bg-black/50 p-4 rounded-lg text-sm text-gray-300 overflow-x-auto">
                            {JSON.stringify(conflictData.localState || {
              nom: "Canvi Local",
              desc: "La teua edició sense connexió"
            }, null, 2)}
                        </pre>
                        <button onClick={handleSelectMine} className="w-full mt-6 bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 px-4 rounded-lg transition-colors">
                    ...
                    <div className="bg-[#2a2a2a] rounded-xl p-6 border-l-4 border-blue-500">
                        ...
                        <pre className="bg-black/50 p-4 rounded-lg text-sm text-gray-300 overflow-x-auto">
                            {JSON.stringify(conflictData.remoteState || {
              nom: "Canvi Remot",
              desc: "Publicat a les 18:04 per Jaume"
            }, null, 2)}
                        </pre>
                        <button onClick={handleSelectTheirs} className="w-full mt-6 bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 px-4 rounded-lg transition-colors">
