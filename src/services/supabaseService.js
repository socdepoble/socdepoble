...
export const supabaseService = {
    ...
    async getAllPersonas() {
        ...
        const lorePersonas = [
            ...
            { id: 'lore-5', full_name: 'Marc Sendra', username: 'marcs', role: 'Ciclisme', primary_town: 'La Torre de les Maçanes', bio: 'Aficionat al ciclisme de muntanya. No hi ha millor port que el de la Carrasqueta.', avatar_url: '/images/demo/avatar_man_2.png' },
